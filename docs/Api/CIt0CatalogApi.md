# MPSolutions\AmznSellingPartnerApi\CIt0CatalogApi

All URIs are relative to https://sellingpartnerapi-na.amazon.com.

Method | HTTP request | Description
------------- | ------------- | -------------
[**getCatalogItem()**](CIt0CatalogApi.md#getCatalogItem) | **GET** /catalog/v0/items/{asin} | 
[**listCatalogCategories()**](CIt0CatalogApi.md#listCatalogCategories) | **GET** /catalog/v0/categories | 
[**listCatalogItems()**](CIt0CatalogApi.md#listCatalogItems) | **GET** /catalog/v0/items | 


## `getCatalogItem()`

```php
getCatalogItem($marketplace_id, $asin): \MPSolutions\AmznSellingPartnerApi\Models\CatalogItemsV0\CIt0GetCatalogItemResponse
```
...
$apiInstance = new MPSolutions\AmznSellingPartnerApi\Api\CIt0CatalogApi(
...
try {
    ...
    echo 'Exception when calling CIt0CatalogApi->getCatalogItem: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\CatalogItemsV0\CIt0GetCatalogItemResponse**](../Model/CIt0GetCatalogItemResponse.md)
...
```php
listCatalogCategories($marketplace_id, $asin, $seller_sku): \MPSolutions\AmznSellingPartnerApi\Models\CatalogItemsV0\CIt0ListCatalogCategoriesResponse
```
...
try {
    ...
    echo 'Exception when calling CIt0CatalogApi->listCatalogCategories: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\CatalogItemsV0\CIt0ListCatalogCategoriesResponse**](../Model/CIt0ListCatalogCategoriesResponse.md)
...
```php
listCatalogItems($marketplace_id, $query, $query_context_id, $seller_sku, $upc, $ean, $isbn, $jan): \MPSolutions\AmznSellingPartnerApi\Models\CatalogItemsV0\CIt0ListCatalogItemsResponse
```
...
try {
    ...
    echo 'Exception when calling CIt0CatalogApi->listCatalogItems: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\CatalogItemsV0\CIt0ListCatalogItemsResponse**](../Model/CIt0ListCatalogItemsResponse.md)
