# MPSolutions\AmznSellingPartnerApi\ProductPricingApi
...
```php
getCompetitivePricing($marketplace_id, $item_type, $asins, $skus, $customer_type): \MPSolutions\AmznSellingPartnerApi\Models\ProductPricing\GetPricingResponse
```
...
$apiInstance = new MPSolutions\AmznSellingPartnerApi\Api\ProductPricingApi(
...
[**\MPSolutions\AmznSellingPartnerApi\Models\ProductPricing\GetPricingResponse**](../Model/GetPricingResponse.md)
...
```php
getItemOffers($marketplace_id, $item_condition, $asin, $customer_type): \MPSolutions\AmznSellingPartnerApi\Models\ProductPricing\GetOffersResponse
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\ProductPricing\GetOffersResponse**](../Model/GetOffersResponse.md)
...
```php
getListingOffers($marketplace_id, $item_condition, $seller_sku, $customer_type): \MPSolutions\AmznSellingPartnerApi\Models\ProductPricing\GetOffersResponse
```
...
```php
getPricing($marketplace_id, $item_type, $asins, $skus, $item_condition, $offer_type): \MPSolutions\AmznSellingPartnerApi\Models\ProductPricing\GetPricingResponse
```
