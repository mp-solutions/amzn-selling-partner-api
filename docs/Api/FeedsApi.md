# MPSolutions\AmznSellingPartnerApi\FeedsApi
...
$apiInstance = new MPSolutions\AmznSellingPartnerApi\Api\FeedsApi(
...
```php
createFeed($body): \MPSolutions\AmznSellingPartnerApi\Models\Feeds\CreateFeedResponse
```
...
$body = new \MPSolutions\AmznSellingPartnerApi\Models\Feeds\CreateFeedSpecification(); // \MPSolutions\AmznSellingPartnerApi\Models\Feeds\CreateFeedSpecification
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\MPSolutions\AmznSellingPartnerApi\Models\Feeds\CreateFeedSpecification**](../Model/CreateFeedSpecification.md)|  |

### Return type

[**\MPSolutions\AmznSellingPartnerApi\Models\Feeds\CreateFeedResponse**](../Model/CreateFeedResponse.md)
...
```php
createFeedDocument($body): \MPSolutions\AmznSellingPartnerApi\Models\Feeds\CreateFeedDocumentResponse
```
...
$body = new \MPSolutions\AmznSellingPartnerApi\Models\Feeds\CreateFeedDocumentSpecification(); // \MPSolutions\AmznSellingPartnerApi\Models\Feeds\CreateFeedDocumentSpecification
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\MPSolutions\AmznSellingPartnerApi\Models\Feeds\CreateFeedDocumentSpecification**](../Model/CreateFeedDocumentSpecification.md)|  |

### Return type

[**\MPSolutions\AmznSellingPartnerApi\Models\Feeds\CreateFeedDocumentResponse**](../Model/CreateFeedDocumentResponse.md)
...
```php
getFeeds($feed_types, $marketplace_ids, $page_size, $processing_statuses, $created_since, $created_until, $next_token): \MPSolutions\AmznSellingPartnerApi\Models\Feeds\GetFeedsResponse
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\Feeds\GetFeedsResponse**](../Model/GetFeedsResponse.md)
