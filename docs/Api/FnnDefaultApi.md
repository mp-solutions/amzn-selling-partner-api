# MPSolutions\AmznSellingPartnerApi\FnnDefaultApi

All URIs are relative to https://sellingpartnerapi-na.amazon.com.

Method | HTTP request | Description
------------- | ------------- | -------------
[**listFinancialEventGroups()**](FnnDefaultApi.md#listFinancialEventGroups) | **GET** /finances/v0/financialEventGroups | 
[**listFinancialEvents()**](FnnDefaultApi.md#listFinancialEvents) | **GET** /finances/v0/financialEvents | 
[**listFinancialEventsByGroupId()**](FnnDefaultApi.md#listFinancialEventsByGroupId) | **GET** /finances/v0/financialEventGroups/{eventGroupId}/financialEvents | 
[**listFinancialEventsByOrderId()**](FnnDefaultApi.md#listFinancialEventsByOrderId) | **GET** /finances/v0/orders/{orderId}/financialEvents | 


## `listFinancialEventGroups()`

```php
listFinancialEventGroups($max_results_per_page, $financial_event_group_started_before, $financial_event_group_started_after, $next_token): \MPSolutions\AmznSellingPartnerApi\Models\Finances\FnnListFinancialEventGroupsResponse
```
...
$apiInstance = new MPSolutions\AmznSellingPartnerApi\Api\FnnDefaultApi(
...
try {
    ...
    echo 'Exception when calling FnnDefaultApi->listFinancialEventGroups: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\Finances\FnnListFinancialEventGroupsResponse**](../Model/FnnListFinancialEventGroupsResponse.md)
...
```php
listFinancialEvents($max_results_per_page, $posted_after, $posted_before, $next_token): \MPSolutions\AmznSellingPartnerApi\Models\Finances\FnnListFinancialEventsResponse
```
...
try {
    ...
    echo 'Exception when calling FnnDefaultApi->listFinancialEvents: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\Finances\FnnListFinancialEventsResponse**](../Model/FnnListFinancialEventsResponse.md)
...
```php
listFinancialEventsByGroupId($event_group_id, $max_results_per_page, $next_token): \MPSolutions\AmznSellingPartnerApi\Models\Finances\FnnListFinancialEventsResponse
```
...
try {
    ...
    echo 'Exception when calling FnnDefaultApi->listFinancialEventsByGroupId: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
listFinancialEventsByOrderId($order_id, $max_results_per_page, $next_token): \MPSolutions\AmznSellingPartnerApi\Models\Finances\FnnListFinancialEventsResponse
```
...
try {
    ...
    echo 'Exception when calling FnnDefaultApi->listFinancialEventsByOrderId: ', $e->getMessage(), PHP_EOL;
}
```
