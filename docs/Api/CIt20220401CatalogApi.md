# MPSolutions\AmznSellingPartnerApi\CIt20220401CatalogApi

All URIs are relative to https://sellingpartnerapi-na.amazon.com.

Method | HTTP request | Description
------------- | ------------- | -------------
[**getCatalogItem()**](CIt20220401CatalogApi.md#getCatalogItem) | **GET** /catalog/2022-04-01/items/{asin} | 
[**searchCatalogItems()**](CIt20220401CatalogApi.md#searchCatalogItems) | **GET** /catalog/2022-04-01/items | 


## `getCatalogItem()`

```php
getCatalogItem($asin, $marketplace_ids, $included_data, $locale): \MPSolutions\AmznSellingPartnerApi\Models\CatalogItems20220401\CIt20220401Item
```
...
$apiInstance = new MPSolutions\AmznSellingPartnerApi\Api\CIt20220401CatalogApi(
...
try {
    ...
    echo 'Exception when calling CIt20220401CatalogApi->getCatalogItem: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\CatalogItems20220401\CIt20220401Item**](../Model/CIt20220401Item.md)
...
```php
searchCatalogItems($marketplace_ids, $identifiers, $identifiers_type, $included_data, $locale, $seller_id, $keywords, $brand_names, $classification_ids, $page_size, $page_token, $keywords_locale): \MPSolutions\AmznSellingPartnerApi\Models\CatalogItems20220401\CIt20220401ItemSearchResults
```
...
try {
    ...
    echo 'Exception when calling CIt20220401CatalogApi->searchCatalogItems: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\CatalogItems20220401\CIt20220401ItemSearchResults**](../Model/CIt20220401ItemSearchResults.md)
