# MPSolutions\AmznSellingPartnerApi\Fds20210630FeedsApi

All URIs are relative to https://sellingpartnerapi-na.amazon.com.

Method | HTTP request | Description
------------- | ------------- | -------------
[**cancelFeed()**](Fds20210630FeedsApi.md#cancelFeed) | **DELETE** /feeds/2021-06-30/feeds/{feedId} | 
[**createFeed()**](Fds20210630FeedsApi.md#createFeed) | **POST** /feeds/2021-06-30/feeds | 
[**createFeedDocument()**](Fds20210630FeedsApi.md#createFeedDocument) | **POST** /feeds/2021-06-30/documents | 
[**getFeed()**](Fds20210630FeedsApi.md#getFeed) | **GET** /feeds/2021-06-30/feeds/{feedId} | 
[**getFeedDocument()**](Fds20210630FeedsApi.md#getFeedDocument) | **GET** /feeds/2021-06-30/documents/{feedDocumentId} | 
[**getFeeds()**](Fds20210630FeedsApi.md#getFeeds) | **GET** /feeds/2021-06-30/feeds | 
...
$apiInstance = new MPSolutions\AmznSellingPartnerApi\Api\Fds20210630FeedsApi(
...
try {
    ...
    echo 'Exception when calling Fds20210630FeedsApi->cancelFeed: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
createFeed($body): \MPSolutions\AmznSellingPartnerApi\Models\Feeds20210630\Fds20210630CreateFeedResponse
```
...
$body = new \MPSolutions\AmznSellingPartnerApi\Models\Feeds20210630\Fds20210630CreateFeedSpecification(); // \MPSolutions\AmznSellingPartnerApi\Models\Feeds20210630\Fds20210630CreateFeedSpecification

try {
    $result = $apiInstance->createFeed($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling Fds20210630FeedsApi->createFeed: ', $e->getMessage(), PHP_EOL;
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\MPSolutions\AmznSellingPartnerApi\Models\Feeds20210630\Fds20210630CreateFeedSpecification**](../Model/Fds20210630CreateFeedSpecification.md)|  |

### Return type

[**\MPSolutions\AmznSellingPartnerApi\Models\Feeds20210630\Fds20210630CreateFeedResponse**](../Model/Fds20210630CreateFeedResponse.md)
...
```php
createFeedDocument($body): \MPSolutions\AmznSellingPartnerApi\Models\Feeds20210630\Fds20210630CreateFeedDocumentResponse
```
...
$body = new \MPSolutions\AmznSellingPartnerApi\Models\Feeds20210630\Fds20210630CreateFeedDocumentSpecification(); // \MPSolutions\AmznSellingPartnerApi\Models\Feeds20210630\Fds20210630CreateFeedDocumentSpecification

try {
    $result = $apiInstance->createFeedDocument($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling Fds20210630FeedsApi->createFeedDocument: ', $e->getMessage(), PHP_EOL;
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\MPSolutions\AmznSellingPartnerApi\Models\Feeds20210630\Fds20210630CreateFeedDocumentSpecification**](../Model/Fds20210630CreateFeedDocumentSpecification.md)|  |

### Return type

[**\MPSolutions\AmznSellingPartnerApi\Models\Feeds20210630\Fds20210630CreateFeedDocumentResponse**](../Model/Fds20210630CreateFeedDocumentResponse.md)
...
```php
getFeed($feed_id): \MPSolutions\AmznSellingPartnerApi\Models\Feeds20210630\Fds20210630Feed
```
...
try {
    ...
    echo 'Exception when calling Fds20210630FeedsApi->getFeed: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\Feeds20210630\Fds20210630Feed**](../Model/Fds20210630Feed.md)
...
```php
getFeedDocument($feed_document_id): \MPSolutions\AmznSellingPartnerApi\Models\Feeds20210630\Fds20210630FeedDocument
```
...
try {
    ...
    echo 'Exception when calling Fds20210630FeedsApi->getFeedDocument: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\Feeds20210630\Fds20210630FeedDocument**](../Model/Fds20210630FeedDocument.md)
...
```php
getFeeds($feed_types, $marketplace_ids, $page_size, $processing_statuses, $created_since, $created_until, $next_token): \MPSolutions\AmznSellingPartnerApi\Models\Feeds20210630\Fds20210630GetFeedsResponse
```
...
try {
    ...
    echo 'Exception when calling Fds20210630FeedsApi->getFeeds: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\Feeds20210630\Fds20210630GetFeedsResponse**](../Model/Fds20210630GetFeedsResponse.md)
