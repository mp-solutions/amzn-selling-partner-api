# MPSolutions\AmznSellingPartnerApi\VDSCustomerInvoicesApi

All URIs are relative to https://sellingpartnerapi-na.amazon.com.

Method | HTTP request | Description
------------- | ------------- | -------------
[**getCustomerInvoice()**](VDSCustomerInvoicesApi.md#getCustomerInvoice) | **GET** /vendor/directFulfillment/shipping/v1/customerInvoices/{purchaseOrderNumber} | 
[**getCustomerInvoices()**](VDSCustomerInvoicesApi.md#getCustomerInvoices) | **GET** /vendor/directFulfillment/shipping/v1/customerInvoices | 


## `getCustomerInvoice()`

```php
getCustomerInvoice($purchase_order_number): \MPSolutions\AmznSellingPartnerApi\Models\VendorDirectFulfillmentShipping\VDSGetCustomerInvoiceResponse
```
...
$apiInstance = new MPSolutions\AmznSellingPartnerApi\Api\VDSCustomerInvoicesApi(
...
try {
    ...
    echo 'Exception when calling VDSCustomerInvoicesApi->getCustomerInvoice: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\VendorDirectFulfillmentShipping\VDSGetCustomerInvoiceResponse**](../Model/VDSGetCustomerInvoiceResponse.md)
...
```php
getCustomerInvoices($created_after, $created_before, $ship_from_party_id, $limit, $sort_order, $next_token): \MPSolutions\AmznSellingPartnerApi\Models\VendorDirectFulfillmentShipping\VDSGetCustomerInvoicesResponse
```
...
try {
    ...
    echo 'Exception when calling VDSCustomerInvoicesApi->getCustomerInvoices: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\VendorDirectFulfillmentShipping\VDSGetCustomerInvoicesResponse**](../Model/VDSGetCustomerInvoicesResponse.md)
