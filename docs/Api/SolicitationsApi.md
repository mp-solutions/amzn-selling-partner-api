# MPSolutions\AmznSellingPartnerApi\SolicitationsApi
...
```php
createProductReviewAndSellerFeedbackSolicitation($amazon_order_id, $marketplace_ids): \MPSolutions\AmznSellingPartnerApi\Models\Solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse
```
...
$apiInstance = new MPSolutions\AmznSellingPartnerApi\Api\SolicitationsApi(
...
[**\MPSolutions\AmznSellingPartnerApi\Models\Solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse**](../Model/CreateProductReviewAndSellerFeedbackSolicitationResponse.md)
...
```php
getSolicitationActionsForOrder($amazon_order_id, $marketplace_ids): \MPSolutions\AmznSellingPartnerApi\Models\Solicitations\GetSolicitationActionsForOrderResponse
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\Solicitations\GetSolicitationActionsForOrderResponse**](../Model/GetSolicitationActionsForOrderResponse.md)
