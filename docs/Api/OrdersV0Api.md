# MPSolutions\AmznSellingPartnerApi\OrdersV0Api
...
```php
getOrder($order_id): \MPSolutions\AmznSellingPartnerApi\Models\Orders\GetOrderResponse
```
...
$apiInstance = new MPSolutions\AmznSellingPartnerApi\Api\OrdersV0Api(
...
[**\MPSolutions\AmznSellingPartnerApi\Models\Orders\GetOrderResponse**](../Model/GetOrderResponse.md)
...
```php
getOrderAddress($order_id): \MPSolutions\AmznSellingPartnerApi\Models\Orders\GetOrderAddressResponse
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\Orders\GetOrderAddressResponse**](../Model/GetOrderAddressResponse.md)
...
```php
getOrderBuyerInfo($order_id): \MPSolutions\AmznSellingPartnerApi\Models\Orders\GetOrderBuyerInfoResponse
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\Orders\GetOrderBuyerInfoResponse**](../Model/GetOrderBuyerInfoResponse.md)
...
```php
getOrderItems($order_id, $next_token): \MPSolutions\AmznSellingPartnerApi\Models\Orders\GetOrderItemsResponse
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\Orders\GetOrderItemsResponse**](../Model/GetOrderItemsResponse.md)
...
```php
getOrderItemsBuyerInfo($order_id, $next_token): \MPSolutions\AmznSellingPartnerApi\Models\Orders\GetOrderItemsBuyerInfoResponse
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\Orders\GetOrderItemsBuyerInfoResponse**](../Model/GetOrderItemsBuyerInfoResponse.md)
...
[**\MPSolutions\AmznSellingPartnerApi\Models\Orders\GetOrdersResponse**](../Model/GetOrdersResponse.md)
