# MPSolutions\AmznSellingPartnerApi\DefaultApi
...
```php
listFinancialEventGroups($max_results_per_page, $financial_event_group_started_before, $financial_event_group_started_after, $next_token): \MPSolutions\AmznSellingPartnerApi\Models\Finances\ListFinancialEventGroupsResponse
```
...
$apiInstance = new MPSolutions\AmznSellingPartnerApi\Api\DefaultApi(
...
[**\MPSolutions\AmznSellingPartnerApi\Models\Finances\ListFinancialEventGroupsResponse**](../Model/ListFinancialEventGroupsResponse.md)
...
```php
listFinancialEvents($max_results_per_page, $posted_after, $posted_before, $next_token): \MPSolutions\AmznSellingPartnerApi\Models\Finances\ListFinancialEventsResponse
```
...
[**\MPSolutions\AmznSellingPartnerApi\Models\Finances\ListFinancialEventsResponse**](../Model/ListFinancialEventsResponse.md)
...
```php
listFinancialEventsByGroupId($event_group_id, $max_results_per_page, $next_token): \MPSolutions\AmznSellingPartnerApi\Models\Finances\ListFinancialEventsResponse
```
...
```php
listFinancialEventsByOrderId($order_id, $max_results_per_page, $next_token): \MPSolutions\AmznSellingPartnerApi\Models\Finances\ListFinancialEventsResponse
```
