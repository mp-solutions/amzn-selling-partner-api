...
/**
 * FIvFbaInventoryApi Class Doc Comment
 *
 * @category Class
 * @package  MPSolutions\AmznSellingPartnerApi
 * @author   OpenAPI Generator team
...
class FIvFbaInventoryApi
{
     ...
     * @throws \MPSolutions\AmznSellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MPSolutions\AmznSellingPartnerApi\Models\FbaInventory\FIvGetInventorySummariesResponse|\MPSolutions\AmznSellingPartnerApi\Models\FbaInventory\FIvGetInventorySummariesResponse|\MPSolutions\AmznSellingPartnerApi\Models\FbaInventory\FIvGetInventorySummariesResponse|\MPSolutions\AmznSellingPartnerApi\Models\FbaInventory\FIvGetInventorySummariesResponse|\MPSolutions\AmznSellingPartnerApi\Models\FbaInventory\FIvGetInventorySummariesResponse|\MPSolutions\AmznSellingPartnerApi\Models\FbaInventory\FIvGetInventorySummariesResponse|\MPSolutions\AmznSellingPartnerApi\Models\FbaInventory\FIvGetInventorySummariesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInventorySummariesWithHttpInfo($granularity_type, $granularity_id, $marketplace_ids, $details = false, $start_date_time = null, $seller_skus = null, $next_token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MPSolutions\AmznSellingPartnerApi\Models\FbaInventory\FIvGetInventorySummariesResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MPSolutions\AmznSellingPartnerApi\Models\FbaInventory\FIvGetInventorySummariesResponse', []),
            ...
            $returnType = '\MPSolutions\AmznSellingPartnerApi\Models\FbaInventory\FIvGetInventorySummariesResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MPSolutions\AmznSellingPartnerApi\Models\FbaInventory\FIvGetInventorySummariesResponse',
    ...
    public function getInventorySummariesRequest($granularity_type, $granularity_id, $marketplace_ids, $details = false, $start_date_time = null, $seller_skus = null, $next_token = null)
    {
        ...
        if (count($marketplace_ids) > 1) {
            throw new \InvalidArgumentException('invalid value for "$marketplace_ids" when calling FIvFbaInventoryApi.getInventorySummaries, number of items must be less than or equal to 1.');
        }

        if ($seller_skus !== null && count($seller_skus) > 50) {
            throw new \InvalidArgumentException('invalid value for "$seller_skus" when calling FIvFbaInventoryApi.getInventorySummaries, number of items must be less than or equal to 50.');
        }
