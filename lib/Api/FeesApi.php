...
class FeesApi
{
     ...
     * @param  \MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateRequest $body body (required)
     *
     * @throws \MPSolutions\AmznSellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse|\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse|\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse|\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse|\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse|\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse|\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse|\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse
     */
     ...
     *
     * @param  string $asin The Amazon Standard Identification Number (ASIN) of the item. (required)
     * @param  \MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateRequest $body (required)
     *
     * @throws \MPSolutions\AmznSellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse|\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse|\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse|\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse|\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse|\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse|\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse|\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMyFeesEstimateForASINWithHttpInfo($asin, $body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse', []),
            ...
            $returnType = '\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MPSolutions\AmznSellingPartnerApi\Models\ProductFees\GetMyFeesEstimateResponse',
