...
/**
 * UplUploadsApi Class Doc Comment
 *
 * @category Class
 * @package  MPSolutions\AmznSellingPartnerApi
 * @author   OpenAPI Generator team
...
class UplUploadsApi
{
     ...
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse|\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse|\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse|\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse|\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse|\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse|\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse|\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse|\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse
     */
     ...
     * @throws \MPSolutions\AmznSellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse|\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse|\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse|\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse|\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse|\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse|\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse|\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse|\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createUploadDestinationForResourceWithHttpInfo($marketplace_ids, $content_md5, $resource, $content_type = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse', []),
            ...
            $returnType = '\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MPSolutions\AmznSellingPartnerApi\Models\Uploads\UplCreateUploadDestinationResponse',
    ...
    public function createUploadDestinationForResourceRequest($marketplace_ids, $content_md5, $resource, $content_type = null)
    {
        ...
        if (count($marketplace_ids) > 1) {
            throw new \InvalidArgumentException('invalid value for "$marketplace_ids" when calling UplUploadsApi.createUploadDestinationForResource, number of items must be less than or equal to 1.');
        }
