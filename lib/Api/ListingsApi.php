...
class ListingsApi
{
     ...
     * @return \MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ListingsItemSubmissionResponse|\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ErrorList|\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ErrorList|\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ErrorList|\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ErrorList|\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ErrorList|\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ErrorList|\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ErrorList
     */
     ...
     * @throws \MPSolutions\AmznSellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ListingsItemSubmissionResponse|\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ErrorList|\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ErrorList|\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ErrorList|\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ErrorList|\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ErrorList|\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ErrorList|\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteListingsItemWithHttpInfo($seller_id, $sku, $marketplace_ids, $issue_locale = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ListingsItemSubmissionResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ListingsItemSubmissionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ErrorList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ErrorList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ListingsItemSubmissionResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ListingsItemSubmissionResponse',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ErrorList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $sku A selling partner provided identifier for an Amazon listing. (required)
     * @param  string[] $marketplace_ids A comma-delimited list of Amazon marketplace identifiers for the request. (required)
     * @param  \MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ListingsItemPatchRequest $body The request body schema for the patchListingsItem operation. (required)
     * @param  string $issue_locale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: \&quot;en_US\&quot;, \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. Localized messages default to \&quot;en_US\&quot; when a localization is not available in the specified locale. (optional)
     *
     * @throws \MPSolutions\AmznSellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  string $sku A selling partner provided identifier for an Amazon listing. (required)
     * @param  string[] $marketplace_ids A comma-delimited list of Amazon marketplace identifiers for the request. (required)
     * @param  \MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\ListingsItemPutRequest $body The request body schema for the putListingsItem operation. (required)
     * @param  string $issue_locale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: \&quot;en_US\&quot;, \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. Localized messages default to \&quot;en_US\&quot; when a localization is not available in the specified locale. (optional)
     *
     * @throws \MPSolutions\AmznSellingPartnerApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
