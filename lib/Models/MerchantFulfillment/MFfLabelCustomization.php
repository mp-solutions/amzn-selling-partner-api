...
/**
 * MFfLabelCustomization Class Doc Comment
 *
 * @category Class
 ...
 */
class MFfLabelCustomization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCustomTextForLabel($custom_text_for_label)
    {
        if (!is_null($custom_text_for_label) && (mb_strlen($custom_text_for_label) > 14)) {
            throw new \InvalidArgumentException('invalid length for $custom_text_for_label when calling MFfLabelCustomization., must be smaller than or equal to 14.');
        }
