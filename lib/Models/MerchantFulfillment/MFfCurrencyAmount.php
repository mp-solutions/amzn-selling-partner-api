...
/**
 * MFfCurrencyAmount Class Doc Comment
 *
 * @category Class
 ...
 */
class MFfCurrencyAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCurrencyCode($currency_code)
    {
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling MFfCurrencyAmount., must be smaller than or equal to 3.');
        }
