...
/**
 * MFfShipmentRequestDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class MFfShipmentRequestDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'label_customization' => '\MPSolutions\AmznSellingPartnerApi\Models\MerchantFulfillment\MFfLabelCustomization'
    ];
    ...
    public function setSellerOrderId($seller_order_id)
    {
        if (!is_null($seller_order_id) && (mb_strlen($seller_order_id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $seller_order_id when calling MFfShipmentRequestDetails., must be smaller than or equal to 64.');
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\MerchantFulfillment\MFfLabelCustomization|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\MerchantFulfillment\MFfLabelCustomization|null $label_customization label_customization
     *
     * @return self
     */
