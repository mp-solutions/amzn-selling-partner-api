...
/**
 * NtfEventBridgeResource Class Doc Comment
 *
 * @category Class
 ...
 */
class NtfEventBridgeResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NtfEventBridgeResource., must be smaller than or equal to 256.');
        }
