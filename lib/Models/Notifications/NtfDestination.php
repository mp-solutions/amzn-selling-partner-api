...
/**
 * NtfDestination Class Doc Comment
 *
 * @category Class
 ...
 */
class NtfDestination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'resource' => '\MPSolutions\AmznSellingPartnerApi\Models\Notifications\NtfDestinationResource'
    ];
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NtfDestination., must be smaller than or equal to 256.');
        }
     ...
     * Gets resource
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Notifications\NtfDestinationResource
     */
     ...
     * Sets resource
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Notifications\NtfDestinationResource $resource resource
     *
     * @return self
     */
