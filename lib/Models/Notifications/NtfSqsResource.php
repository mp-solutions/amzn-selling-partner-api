...
/**
 * NtfSqsResource Class Doc Comment
 *
 * @category Class
 ...
 */
class NtfSqsResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setArn($arn)
    {
        if ((mb_strlen($arn) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $arn when calling NtfSqsResource., must be smaller than or equal to 1000.');
        }
        if ((!preg_match("/^arn:aws:sqs:\\S+:\\S+:\\S+/", $arn))) {
            throw new \InvalidArgumentException("invalid value for $arn when calling NtfSqsResource., must conform to the pattern /^arn:aws:sqs:\\S+:\\S+:\\S+/.");
        }
