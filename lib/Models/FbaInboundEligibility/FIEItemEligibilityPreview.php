...
/**
 * FIEItemEligibilityPreview Class Doc Comment
 *
 * @category Class
 ...
 */
class FIEItemEligibilityPreview implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const INELIGIBILITY_REASON_LIST_FBA_INB_0096 = 'FBA_INB_0096'; // non-exist on documentation
    ...
    public function getIneligibilityReasonListAllowableValues()
    {
        return [
            ...
            self::INELIGIBILITY_REASON_LIST_FBA_INB_0096,
