...
/**
 * VDSShipmentStatusUpdate Class Doc Comment
 *
 * @category Class
 * @package  MPSolutions\AmznSellingPartnerApi
 * @author   OpenAPI Generator team
 ...
 */
class VDSShipmentStatusUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'status_update_details' => '\MPSolutions\AmznSellingPartnerApi\Models\VendorDirectFulfillmentShipping\VDSStatusUpdateDetails'
    ];
    ...
    public function setPurchaseOrderNumber($purchase_order_number)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $purchase_order_number))) {
            throw new \InvalidArgumentException("invalid value for $purchase_order_number when calling VDSShipmentStatusUpdate., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\VendorDirectFulfillmentShipping\VDSStatusUpdateDetails
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\VendorDirectFulfillmentShipping\VDSStatusUpdateDetails $status_update_details status_update_details
     *
     * @return self
     */
