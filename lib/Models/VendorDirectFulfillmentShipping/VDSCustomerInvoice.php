...
/**
 * VDSCustomerInvoice Class Doc Comment
 *
 * @category Class
 * @package  MPSolutions\AmznSellingPartnerApi
 * @author   OpenAPI Generator team
 ...
 */
class VDSCustomerInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPurchaseOrderNumber($purchase_order_number)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $purchase_order_number))) {
            throw new \InvalidArgumentException("invalid value for $purchase_order_number when calling VDSCustomerInvoice., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
