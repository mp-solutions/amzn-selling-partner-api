<?php
/**
 * VDSSubmitShipmentStatusUpdatesRequest
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * VDSSubmitShipmentStatusUpdatesRequest Class Doc Comment
 *
 * @category Class
 * @package  MPSolutions\AmznSellingPartnerApi
 * @author   OpenAPI Generator team
 ...
 */
class VDSSubmitShipmentStatusUpdatesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'shipment_status_updates' => '\MPSolutions\AmznSellingPartnerApi\Models\VendorDirectFulfillmentShipping\VDSShipmentStatusUpdate[]'
    ];
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\VendorDirectFulfillmentShipping\VDSShipmentStatusUpdate[]|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\VendorDirectFulfillmentShipping\VDSShipmentStatusUpdate[]|null $shipment_status_updates shipment_status_updates
     *
     * @return self
     */
    public function setShipmentStatusUpdates($shipment_status_updates)
    {
        ...
        if (!is_null($shipment_status_updates) && (count($shipment_status_updates) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shipment_status_updates when calling VDSSubmitShipmentStatusUpdatesRequest., number of items must be greater than or equal to 1.');
        }
