...
/**
 * VDSShippingLabel Class Doc Comment
 *
 * @category Class
 * @package  MPSolutions\AmznSellingPartnerApi
 * @author   OpenAPI Generator team
 ...
 */
class VDSShippingLabel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'label_format' => 'string',
        'label_data' => '\MPSolutions\AmznSellingPartnerApi\Models\VendorDirectFulfillmentShipping\VDSLabelData[]'
    ];
    ...
    public function setPurchaseOrderNumber($purchase_order_number)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]+$/", $purchase_order_number))) {
            throw new \InvalidArgumentException("invalid value for $purchase_order_number when calling VDSShippingLabel., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     * Gets label_data
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\VendorDirectFulfillmentShipping\VDSLabelData[]
     */
     ...
     * Sets label_data
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\VendorDirectFulfillmentShipping\VDSLabelData[] $label_data Provides the details of the packages in this shipment.
     *
     * @return self
     */
