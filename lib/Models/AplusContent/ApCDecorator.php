...
/**
 * ApCDecorator Class Doc Comment
 *
 * @category Class
 ...
 */
class ApCDecorator implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'type' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCDecoratorType',
        'offset' => 'int',
        'length' => 'int',
        'depth' => 'int'
    ];
     ...
     * Gets type
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCDecoratorType|null
     */
     ...
     * Sets type
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCDecoratorType|null $type type
     *
     * @return self
     */
    ...
    public function setOffset($offset)
    {
        ...
        if (!is_null($offset) && ($offset > 10000)) {
            throw new \InvalidArgumentException('invalid value for $offset when calling ApCDecorator., must be smaller than or equal to 10000.');
        }
        if (!is_null($offset) && ($offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $offset when calling ApCDecorator., must be bigger than or equal to 0.');
        }
    ...
    public function setLength($length)
    {
        ...
        if (!is_null($length) && ($length > 10000)) {
            throw new \InvalidArgumentException('invalid value for $length when calling ApCDecorator., must be smaller than or equal to 10000.');
        }
        if (!is_null($length) && ($length < 0)) {
            throw new \InvalidArgumentException('invalid value for $length when calling ApCDecorator., must be bigger than or equal to 0.');
        }
    ...
    public function setDepth($depth)
    {
        ...
        if (!is_null($depth) && ($depth > 100)) {
            throw new \InvalidArgumentException('invalid value for $depth when calling ApCDecorator., must be smaller than or equal to 100.');
        }
        if (!is_null($depth) && ($depth < 0)) {
            throw new \InvalidArgumentException('invalid value for $depth when calling ApCDecorator., must be bigger than or equal to 0.');
        }
