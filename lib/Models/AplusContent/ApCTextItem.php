 ...
 */
class ApCTextItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'position' => 'int',
        'text' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCTextComponent'
    ];
    ...
    public function setPosition($position)
    {
        ...
        if (($position > 100)) {
            throw new \InvalidArgumentException('invalid value for $position when calling ApCTextItem., must be smaller than or equal to 100.');
        }
        if (($position < 1)) {
            throw new \InvalidArgumentException('invalid value for $position when calling ApCTextItem., must be bigger than or equal to 1.');
        }
     ...
     * Sets text
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCTextComponent $text text
     *
     * @return self
     */
