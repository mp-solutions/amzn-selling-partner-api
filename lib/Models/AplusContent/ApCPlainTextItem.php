...
/**
 * ApCPlainTextItem Class Doc Comment
 *
 * @category Class
 ...
 */
class ApCPlainTextItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPosition($position)
    {
        ...
        if (($position > 100)) {
            throw new \InvalidArgumentException('invalid value for $position when calling ApCPlainTextItem., must be smaller than or equal to 100.');
        }
        if (($position < 1)) {
            throw new \InvalidArgumentException('invalid value for $position when calling ApCPlainTextItem., must be bigger than or equal to 1.');
        }
    ...
    public function setValue($value)
    {
        if ((mb_strlen($value) > 250)) {
            throw new \InvalidArgumentException('invalid length for $value when calling ApCPlainTextItem., must be smaller than or equal to 250.');
        }
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling ApCPlainTextItem., must be bigger than or equal to 1.');
        }
