 ...
 */
class ApCError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ApCError., must be bigger than or equal to 1.');
        }
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message when calling ApCError., must be bigger than or equal to 1.');
        }
    ...
    public function setDetails($details)
    {
        ...
        if (!is_null($details) && (mb_strlen($details) < 1)) {
            throw new \InvalidArgumentException('invalid length for $details when calling ApCError., must be bigger than or equal to 1.');
        }
