...
/**
 * ApCParagraphComponent Class Doc Comment
 *
 * @category Class
 ...
 */
class ApCParagraphComponent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'text_list' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCTextComponent[]'
    ];
     ...
     * Gets text_list
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCTextComponent[]
     */
     ...
     * Sets text_list
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCTextComponent[] $text_list text_list
     *
     * @return self
     */
    public function setTextList($text_list)
    {
        ...
        if ((count($text_list) > 100)) {
            throw new \InvalidArgumentException('invalid value for $text_list when calling ApCParagraphComponent., number of items must be less than or equal to 100.');
        }
        if ((count($text_list) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text_list when calling ApCParagraphComponent., number of items must be greater than or equal to 1.');
        }
