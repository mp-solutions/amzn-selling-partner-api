...
/**
 * ApCAplusPaginatedResponseAllOf Class Doc Comment
 *
 * @category Class
 * @package  MPSolutions\AmznSellingPartnerApi
 * @author   OpenAPI Generator team
 ...
 */
class ApCAplusPaginatedResponseAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setNextPageToken($next_page_token)
    {
        ...
        if (!is_null($next_page_token) && (mb_strlen($next_page_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $next_page_token when calling ApCAplusPaginatedResponseAllOf., must be bigger than or equal to 1.');
        }
