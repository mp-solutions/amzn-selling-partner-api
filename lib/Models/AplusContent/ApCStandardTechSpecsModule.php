...
/**
 * ApCStandardTechSpecsModule Class Doc Comment
 *
 * @category Class
 ...
 */
class ApCStandardTechSpecsModule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'specification_list' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCStandardTextPairBlock[]',
        'table_count' => 'int'
    ];
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCStandardTextPairBlock[]
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCStandardTextPairBlock[] $specification_list The specification list.
     *
     * @return self
     */
    public function setSpecificationList($specification_list)
    {
        ...
        if ((count($specification_list) > 16)) {
            throw new \InvalidArgumentException('invalid value for $specification_list when calling ApCStandardTechSpecsModule., number of items must be less than or equal to 16.');
        }
        if ((count($specification_list) < 4)) {
            throw new \InvalidArgumentException('invalid length for $specification_list when calling ApCStandardTechSpecsModule., number of items must be greater than or equal to 4.');
        }
    ...
    public function setTableCount($table_count)
    {
        ...
        if (!is_null($table_count) && ($table_count > 2)) {
            throw new \InvalidArgumentException('invalid value for $table_count when calling ApCStandardTechSpecsModule., must be smaller than or equal to 2.');
        }
        if (!is_null($table_count) && ($table_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $table_count when calling ApCStandardTechSpecsModule., must be bigger than or equal to 1.');
        }
