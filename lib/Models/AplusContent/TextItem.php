...
class TextItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'position' => 'int',
        'text' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\TextComponent'
    ];
     ...
     * Sets text
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\TextComponent $text text
     *
     * @return self
     */
