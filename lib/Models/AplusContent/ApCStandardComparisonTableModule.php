<?php
/**
 * ApCStandardComparisonTableModule
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ApCStandardComparisonTableModule Class Doc Comment
 *
 * @category Class
 ...
 */
class ApCStandardComparisonTableModule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'product_columns' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCStandardComparisonProductBlock[]',
        'metric_row_labels' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCPlainTextItem[]'
    ];
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCStandardComparisonProductBlock[]|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCStandardComparisonProductBlock[]|null $product_columns product_columns
     *
     * @return self
     */
    public function setProductColumns($product_columns)
    {
        ...
        if (!is_null($product_columns) && (count($product_columns) > 6)) {
            throw new \InvalidArgumentException('invalid value for $product_columns when calling ApCStandardComparisonTableModule., number of items must be less than or equal to 6.');
        }
        if (!is_null($product_columns) && (count($product_columns) < 0)) {
            throw new \InvalidArgumentException('invalid length for $product_columns when calling ApCStandardComparisonTableModule., number of items must be greater than or equal to 0.');
        }
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCPlainTextItem[]|null $metric_row_labels metric_row_labels
     *
     * @return self
     */
    public function setMetricRowLabels($metric_row_labels)
    {
        ...
        if (!is_null($metric_row_labels) && (count($metric_row_labels) > 10)) {
            throw new \InvalidArgumentException('invalid value for $metric_row_labels when calling ApCStandardComparisonTableModule., number of items must be less than or equal to 10.');
        }
        if (!is_null($metric_row_labels) && (count($metric_row_labels) < 0)) {
            throw new \InvalidArgumentException('invalid length for $metric_row_labels when calling ApCStandardComparisonTableModule., number of items must be greater than or equal to 0.');
        }
