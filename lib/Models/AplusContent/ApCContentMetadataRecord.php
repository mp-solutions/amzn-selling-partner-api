...
/**
 * ApCContentMetadataRecord Class Doc Comment
 *
 * @category Class
 ...
 */
class ApCContentMetadataRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setContentReferenceKey($content_reference_key)
    {
        ...
        if ((mb_strlen($content_reference_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $content_reference_key when calling ApCContentMetadataRecord., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCContentMetadata
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCContentMetadata $content_metadata content_metadata
     *
     * @return self
     */
