...
/**
 * ApCPublishRecord Class Doc Comment
 *
 * @category Class
 ...
 */
class ApCPublishRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setMarketplaceId($marketplace_id)
    {
        ...
        if ((mb_strlen($marketplace_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $marketplace_id when calling ApCPublishRecord., must be bigger than or equal to 1.');
        }
    ...
    public function setLocale($locale)
    {
        ...
        if ((mb_strlen($locale) < 5)) {
            throw new \InvalidArgumentException('invalid length for $locale when calling ApCPublishRecord., must be bigger than or equal to 5.');
        }
    ...
    public function setAsin($asin)
    {
        ...
        if ((mb_strlen($asin) < 10)) {
            throw new \InvalidArgumentException('invalid length for $asin when calling ApCPublishRecord., must be bigger than or equal to 10.');
        }
    ...
    public function setContentSubType($content_sub_type)
    {
        ...
        if (!is_null($content_sub_type) && (mb_strlen($content_sub_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $content_sub_type when calling ApCPublishRecord., must be bigger than or equal to 1.');
        }
    ...
    public function setContentReferenceKey($content_reference_key)
    {
        ...
        if ((mb_strlen($content_reference_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $content_reference_key when calling ApCPublishRecord., must be bigger than or equal to 1.');
        }
