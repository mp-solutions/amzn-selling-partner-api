...
/**
 * ApCContentDocument Class Doc Comment
 *
 * @category Class
 ...
 */
class ApCContentDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'content_type' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCContentType',
        'content_sub_type' => 'string',
        'locale' => 'string',
        'content_module_list' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCContentModule[]'
    ];
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ApCContentDocument., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ApCContentDocument., must be bigger than or equal to 1.');
        }
     ...
     * Gets content_type
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCContentType
     */
     ...
     * Sets content_type
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCContentType $content_type content_type
     *
     * @return self
     */
    ...
    public function setContentSubType($content_sub_type)
    {
        ...
        if (!is_null($content_sub_type) && (mb_strlen($content_sub_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $content_sub_type when calling ApCContentDocument., must be bigger than or equal to 1.');
        }
    ...
    public function setLocale($locale)
    {
        ...
        if ((mb_strlen($locale) < 5)) {
            throw new \InvalidArgumentException('invalid length for $locale when calling ApCContentDocument., must be bigger than or equal to 5.');
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCContentModule[]
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCContentModule[] $content_module_list A list of A+ Content modules.
     *
     * @return self
     */
    public function setContentModuleList($content_module_list)
    {
        ...
        if ((count($content_module_list) > 100)) {
            throw new \InvalidArgumentException('invalid value for $content_module_list when calling ApCContentDocument., number of items must be less than or equal to 100.');
        }
        if ((count($content_module_list) < 1)) {
            throw new \InvalidArgumentException('invalid length for $content_module_list when calling ApCContentDocument., number of items must be greater than or equal to 1.');
        }
