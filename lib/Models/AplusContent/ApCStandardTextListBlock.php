...
/**
 * ApCStandardTextListBlock Class Doc Comment
 *
 * @category Class
 ...
 */
class ApCStandardTextListBlock implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'text_list' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCTextItem[]'
    ];
     ...
     * Gets text_list
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCTextItem[]
     */
     ...
     * Sets text_list
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCTextItem[] $text_list text_list
     *
     * @return self
     */
    public function setTextList($text_list)
    {
        ...
        if ((count($text_list) > 8)) {
            throw new \InvalidArgumentException('invalid value for $text_list when calling ApCStandardTextListBlock., number of items must be less than or equal to 8.');
        }
        if ((count($text_list) < 0)) {
            throw new \InvalidArgumentException('invalid length for $text_list when calling ApCStandardTextListBlock., number of items must be greater than or equal to 0.');
        }
