...
/**
 * ApCAsinMetadata Class Doc Comment
 *
 * @category Class
 ...
 */
class ApCAsinMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'asin' => 'string',
        'badge_set' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCAsinBadge[]',
        'parent' => 'string',
        'title' => 'string',
        'image_url' => 'string',
    ...
    public function setAsin($asin)
    {
        ...
        if ((mb_strlen($asin) < 10)) {
            throw new \InvalidArgumentException('invalid length for $asin when calling ApCAsinMetadata., must be bigger than or equal to 10.');
        }
     ...
     * Gets badge_set
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCAsinBadge[]|null
     */
     ...
     * Sets badge_set
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCAsinBadge[]|null $badge_set The set of ASIN badges.
     *
     * @return self
     */
    ...
    public function setParent($parent)
    {
        ...
        if (!is_null($parent) && (mb_strlen($parent) < 10)) {
            throw new \InvalidArgumentException('invalid length for $parent when calling ApCAsinMetadata., must be bigger than or equal to 10.');
        }
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ApCAsinMetadata., must be bigger than or equal to 1.');
        }
    ...
    public function setImageUrl($image_url)
    {
        ...
        if (!is_null($image_url) && (mb_strlen($image_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling ApCAsinMetadata., must be bigger than or equal to 1.');
        }
