...
/**
 * ApCPostContentDocumentResponseAllOf Class Doc Comment
 *
 * @category Class
 * @package  MPSolutions\AmznSellingPartnerApi
 * @author   OpenAPI Generator team
 ...
 */
class ApCPostContentDocumentResponseAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setContentReferenceKey($content_reference_key)
    {
        ...
        if ((mb_strlen($content_reference_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $content_reference_key when calling ApCPostContentDocumentResponseAllOf., must be bigger than or equal to 1.');
        }
