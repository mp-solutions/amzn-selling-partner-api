...
/**
 * ApCListContentDocumentAsinRelationsResponse Class Doc Comment
 *
 * @category Class
 * @package  MPSolutions\AmznSellingPartnerApi
 * @author   OpenAPI Generator team
 ...
 */
class ApCListContentDocumentAsinRelationsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'asin_metadata_set' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCAsinMetadata[]'
    ];
    ...
    public function setNextPageToken($next_page_token)
    {
        ...
        if (!is_null($next_page_token) && (mb_strlen($next_page_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $next_page_token when calling ApCListContentDocumentAsinRelationsResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCAsinMetadata[]
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCAsinMetadata[] $asin_metadata_set The set of ASIN metadata.
     *
     * @return self
     */
