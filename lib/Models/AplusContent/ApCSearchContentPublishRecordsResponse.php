...
/**
 * ApCSearchContentPublishRecordsResponse Class Doc Comment
 *
 * @category Class
 * @package  MPSolutions\AmznSellingPartnerApi
 * @author   OpenAPI Generator team
 ...
 */
class ApCSearchContentPublishRecordsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'publish_record_list' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCPublishRecord[]'
    ];
    ...
    public function setNextPageToken($next_page_token)
    {
        ...
        if (!is_null($next_page_token) && (mb_strlen($next_page_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $next_page_token when calling ApCSearchContentPublishRecordsResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCPublishRecord[]
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCPublishRecord[] $publish_record_list A list of A+ Content publishing records.
     *
     * @return self
     */
