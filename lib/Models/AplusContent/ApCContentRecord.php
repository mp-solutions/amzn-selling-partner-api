...
/**
 * ApCContentRecord Class Doc Comment
 *
 * @category Class
 ...
 */
class ApCContentRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'content_metadata' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCContentMetadata',
        'content_document' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCContentDocument'
    ];
    ...
    public function setContentReferenceKey($content_reference_key)
    {
        ...
        if ((mb_strlen($content_reference_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $content_reference_key when calling ApCContentRecord., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCContentMetadata|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCContentMetadata|null $content_metadata content_metadata
     *
     * @return self
     */
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCContentDocument|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCContentDocument|null $content_document content_document
     *
     * @return self
     */
