...
/**
 * ApCImageComponent Class Doc Comment
 *
 * @category Class
 ...
 */
class ApCImageComponent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'image_crop_specification' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCImageCropSpecification',
        'alt_text' => 'string'
    ];
    ...
    public function setUploadDestinationId($upload_destination_id)
    {
        ...
        if ((mb_strlen($upload_destination_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $upload_destination_id when calling ApCImageComponent., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCImageCropSpecification
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCImageCropSpecification $image_crop_specification image_crop_specification
     *
     * @return self
     */
    ...
    public function setAltText($alt_text)
    {
        if ((mb_strlen($alt_text) > 100)) {
            throw new \InvalidArgumentException('invalid length for $alt_text when calling ApCImageComponent., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($alt_text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $alt_text when calling ApCImageComponent., must be bigger than or equal to 1.');
        }
