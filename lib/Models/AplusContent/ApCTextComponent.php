...
/**
 * ApCTextComponent Class Doc Comment
 *
 * @category Class
 ...
 */
class ApCTextComponent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'value' => 'string',
        'decorator_set' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCDecorator[]'
    ];
    ...
    public function setValue($value)
    {
        if ((mb_strlen($value) > 10000)) {
            throw new \InvalidArgumentException('invalid length for $value when calling ApCTextComponent., must be smaller than or equal to 10000.');
        }
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling ApCTextComponent., must be bigger than or equal to 1.');
        }
     ...
     * Gets decorator_set
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCDecorator[]|null
     */
     ...
     * Sets decorator_set
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCDecorator[]|null $decorator_set A set of content decorators.
     *
     * @return self
     */
