...
/**
 * ApCStandardComparisonProductBlock Class Doc Comment
 *
 * @category Class
 ...
 */
class ApCStandardComparisonProductBlock implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'asin' => 'string',
        'highlight' => 'bool',
        'metrics' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCPlainTextItem[]'
    ];
    ...
    public function setPosition($position)
    {
        ...
        if (($position > 6)) {
            throw new \InvalidArgumentException('invalid value for $position when calling ApCStandardComparisonProductBlock., must be smaller than or equal to 6.');
        }
        if (($position < 1)) {
            throw new \InvalidArgumentException('invalid value for $position when calling ApCStandardComparisonProductBlock., must be bigger than or equal to 1.');
        }
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (mb_strlen($title) > 80)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ApCStandardComparisonProductBlock., must be smaller than or equal to 80.');
        }
        if (!is_null($title) && (mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ApCStandardComparisonProductBlock., must be bigger than or equal to 1.');
        }
    ...
    public function setAsin($asin)
    {
        ...
        if (!is_null($asin) && (mb_strlen($asin) < 10)) {
            throw new \InvalidArgumentException('invalid length for $asin when calling ApCStandardComparisonProductBlock., must be bigger than or equal to 10.');
        }
     ...
     * Gets metrics
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCPlainTextItem[]|null
     */
     ...
     * Sets metrics
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCPlainTextItem[]|null $metrics Comparison metrics for the product.
     *
     * @return self
     */
    public function setMetrics($metrics)
    {
        ...
        if (!is_null($metrics) && (count($metrics) > 10)) {
            throw new \InvalidArgumentException('invalid value for $metrics when calling ApCStandardComparisonProductBlock., number of items must be less than or equal to 10.');
        }
        if (!is_null($metrics) && (count($metrics) < 0)) {
            throw new \InvalidArgumentException('invalid length for $metrics when calling ApCStandardComparisonProductBlock., number of items must be greater than or equal to 0.');
        }
