...
/**
 * ApCSearchContentDocumentsResponse Class Doc Comment
 *
 * @category Class
 * @package  MPSolutions\AmznSellingPartnerApi
 * @author   OpenAPI Generator team
 ...
 */
class ApCSearchContentDocumentsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'warnings' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCError[]',
        'next_page_token' => 'string',
        'content_metadata_records' => '\MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCContentMetadataRecord[]'
    ];
     ...
     * Gets warnings
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCError[]|null
     */
     ...
     * Sets warnings
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCError[]|null $warnings A set of messages to the user, such as warnings or comments.
     *
     * @return self
     */
    ...
    public function setNextPageToken($next_page_token)
    {
        ...
        if (!is_null($next_page_token) && (mb_strlen($next_page_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $next_page_token when calling ApCSearchContentDocumentsResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCContentMetadataRecord[]
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\AplusContent\ApCContentMetadataRecord[] $content_metadata_records A list of A+ Content metadata records.
     *
     * @return self
     */
