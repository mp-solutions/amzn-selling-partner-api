...
/**
 * VOrImportDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class VOrImportDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPortOfDelivery($port_of_delivery)
    {
        if (!is_null($port_of_delivery) && (mb_strlen($port_of_delivery) > 64)) {
            throw new \InvalidArgumentException('invalid length for $port_of_delivery when calling VOrImportDetails., must be smaller than or equal to 64.');
        }
    ...
    public function setImportContainers($import_containers)
    {
        if (!is_null($import_containers) && (mb_strlen($import_containers) > 64)) {
            throw new \InvalidArgumentException('invalid length for $import_containers when calling VOrImportDetails., must be smaller than or equal to 64.');
        }
