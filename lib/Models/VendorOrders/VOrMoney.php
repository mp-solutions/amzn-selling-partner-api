 ...
 */
class VOrMoney implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCurrencyCode($currency_code)
    {
        if (!is_null($currency_code) && (mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling VOrMoney., must be smaller than or equal to 3.');
        }
