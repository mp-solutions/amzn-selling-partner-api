...
/**
 * SlrMarketplace Class Doc Comment
 *
 * @category Class
 ...
 */
class SlrMarketplace implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((!preg_match("/^([A-Z]{2})$/", $country_code))) {
            throw new \InvalidArgumentException("invalid value for $country_code when calling SlrMarketplace., must conform to the pattern /^([A-Z]{2})$/.");
        }
