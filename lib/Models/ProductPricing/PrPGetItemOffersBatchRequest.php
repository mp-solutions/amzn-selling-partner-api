...
/**
 * PrPGetItemOffersBatchRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PrPGetItemOffersBatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'requests' => '\MPSolutions\AmznSellingPartnerApi\Models\ProductPricing\PrPItemOffersRequest[]'
    ];
     ...
     * Gets requests
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\ProductPricing\PrPItemOffersRequest[]|null
     */
     ...
     * Sets requests
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\ProductPricing\PrPItemOffersRequest[]|null $requests A list of getItemOffers batched requests to run.
     *
     * @return self
     */
    public function setRequests($requests)
    {
        ...
        if (!is_null($requests) && (count($requests) > 20)) {
            throw new \InvalidArgumentException('invalid value for $requests when calling PrPGetItemOffersBatchRequest., number of items must be less than or equal to 20.');
        }
        if (!is_null($requests) && (count($requests) < 1)) {
            throw new \InvalidArgumentException('invalid length for $requests when calling PrPGetItemOffersBatchRequest., number of items must be greater than or equal to 1.');
        }
