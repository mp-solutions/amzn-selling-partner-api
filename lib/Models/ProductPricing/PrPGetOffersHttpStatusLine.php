...
/**
 * PrPGetOffersHttpStatusLine Class Doc Comment
 *
 * @category Class
 ...
 */
class PrPGetOffersHttpStatusLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setStatusCode($status_code)
    {
        ...
        if (!is_null($status_code) && ($status_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $status_code when calling PrPGetOffersHttpStatusLine., must be smaller than or equal to 599.');
        }
        if (!is_null($status_code) && ($status_code < 100)) {
            throw new \InvalidArgumentException('invalid value for $status_code when calling PrPGetOffersHttpStatusLine., must be bigger than or equal to 100.');
        }
