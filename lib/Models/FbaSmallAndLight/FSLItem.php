 ...
 */
class FSLItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets price
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FbaSmallAndLight\FSLMoneyType $price price
     *
     * @return self
     */
