...
class SmallAndLightFeePreviewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\MPSolutions\AmznSellingPartnerApi\Models\FbaSmallAndLight\Item[]'
    ];
     ...
     * Gets items
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FbaSmallAndLight\Item[]
     */
     ...
     * Sets items
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FbaSmallAndLight\Item[] $items A list of items for which to retrieve fee estimates (limit: 25).
     *
     * @return self
     */
