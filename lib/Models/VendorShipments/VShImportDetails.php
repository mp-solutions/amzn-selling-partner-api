...
/**
 * VShImportDetails Class Doc Comment
 *
 * @category Class
 * @package  MPSolutions\AmznSellingPartnerApi
 * @author   OpenAPI Generator team
 ...
 */
class VShImportDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'seal_number' => 'string',
        'route' => '\MPSolutions\AmznSellingPartnerApi\Models\VendorShipments\VShRoute',
        'import_containers' => 'string',
        'billable_weight' => '\MPSolutions\AmznSellingPartnerApi\Models\VendorShipments\VShWeight',
     ...
     * Gets route
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\VendorShipments\VShRoute|null
     */
     ...
     * Sets route
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\VendorShipments\VShRoute|null $route route
     *
     * @return self
     */
    ...
    public function setImportContainers($import_containers)
    {
        if (!is_null($import_containers) && (mb_strlen($import_containers) > 64)) {
            throw new \InvalidArgumentException('invalid length for $import_containers when calling VShImportDetails., must be smaller than or equal to 64.');
        }
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\VendorShipments\VShWeight|null $billable_weight billable_weight
     *
     * @return self
     */
