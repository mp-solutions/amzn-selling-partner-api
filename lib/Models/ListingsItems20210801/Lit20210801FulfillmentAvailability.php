<?php
/**
 * Lit20210801FulfillmentAvailability
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * Lit20210801FulfillmentAvailability Class Doc Comment
 *
 * @category Class
 ...
 */
class Lit20210801FulfillmentAvailability implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling Lit20210801FulfillmentAvailability., must be bigger than or equal to 0.');
        }
