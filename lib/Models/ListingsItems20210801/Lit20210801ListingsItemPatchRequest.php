<?php
/**
 * Lit20210801ListingsItemPatchRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * Lit20210801ListingsItemPatchRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class Lit20210801ListingsItemPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'product_type' => 'string',
        'patches' => '\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems20210801\Lit20210801PatchOperation[]'
    ];
     ...
     * Gets patches
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\ListingsItems20210801\Lit20210801PatchOperation[]
     */
     ...
     * Sets patches
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\ListingsItems20210801\Lit20210801PatchOperation[] $patches One or more JSON Patch operations to perform on the listings item.
     *
     * @return self
     */
    public function setPatches($patches)
    {
        ...
        if ((count($patches) < 1)) {
            throw new \InvalidArgumentException('invalid length for $patches when calling Lit20210801ListingsItemPatchRequest., number of items must be greater than or equal to 1.');
        }
