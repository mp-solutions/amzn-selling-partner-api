...
/**
 * FfI20240320PrepInstruction Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320PrepInstruction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'fee' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Currency',
        'prep_owner' => 'string',
        'prep_type' => 'string'
    ];
     ...
     * Sets fee
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Currency|null $fee fee
     *
     * @return self
     */
    ...
    public function setPrepOwner($prep_owner)
    {
        if (!is_null($prep_owner) && (mb_strlen($prep_owner) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $prep_owner when calling FfI20240320PrepInstruction., must be smaller than or equal to 1024.');
        }
        if (!is_null($prep_owner) && (mb_strlen($prep_owner) < 1)) {
            throw new \InvalidArgumentException('invalid length for $prep_owner when calling FfI20240320PrepInstruction., must be bigger than or equal to 1.');
        }
    ...
    public function setPrepType($prep_type)
    {
        if (!is_null($prep_type) && (mb_strlen($prep_type) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $prep_type when calling FfI20240320PrepInstruction., must be smaller than or equal to 1024.');
        }
        if (!is_null($prep_type) && (mb_strlen($prep_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $prep_type when calling FfI20240320PrepInstruction., must be bigger than or equal to 1.');
        }
