...
/**
 * FfI20240320PackingOption Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320PackingOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'discounts' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Incentive[]',
        'expiration' => '\DateTime',
        'fees' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Incentive[]',
        'packing_groups' => 'string[]',
        'packing_option_id' => 'string',
        'status' => 'string',
        'supported_configurations' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320PackingConfiguration[]',
        'supported_shipping_configurations' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320ShippingConfiguration[]'
    ];
     ...
     * Gets discounts
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Incentive[]
     */
     ...
     * Sets discounts
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Incentive[] $discounts Discount for the offered option.
     *
     * @return self
     */
     ...
     * Sets fees
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Incentive[] $fees Fee for the offered option.
     *
     * @return self
     */
    ...
    public function setPackingOptionId($packing_option_id)
    {
        if ((mb_strlen($packing_option_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $packing_option_id when calling FfI20240320PackingOption., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($packing_option_id) < 38)) {
            throw new \InvalidArgumentException('invalid length for $packing_option_id when calling FfI20240320PackingOption., must be bigger than or equal to 38.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $packing_option_id))) {
            throw new \InvalidArgumentException("invalid value for $packing_option_id when calling FfI20240320PackingOption., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $status when calling FfI20240320PackingOption., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling FfI20240320PackingOption., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320PackingConfiguration[]
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320PackingConfiguration[] $supported_configurations A list of possible configurations for this option.
     *
     * @return self
     */
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320ShippingConfiguration[]
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320ShippingConfiguration[] $supported_shipping_configurations **This field is deprecated**. Use the `shippingRequirements` property under `supportedConfigurations` instead. List of supported shipping modes.
     *
     * @return self
     */
