...
/**
 * FfI20240320Error Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320Error implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCode($code)
    {
        if ((mb_strlen($code) > 256)) {
            throw new \InvalidArgumentException('invalid length for $code when calling FfI20240320Error., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling FfI20240320Error., must be bigger than or equal to 1.');
        }
    ...
    public function setDetails($details)
    {
        if (!is_null($details) && (mb_strlen($details) > 8192)) {
            throw new \InvalidArgumentException('invalid length for $details when calling FfI20240320Error., must be smaller than or equal to 8192.');
        }
        if (!is_null($details) && (mb_strlen($details) < 0)) {
            throw new \InvalidArgumentException('invalid length for $details when calling FfI20240320Error., must be bigger than or equal to 0.');
        }
    ...
    public function setMessage($message)
    {
        if ((mb_strlen($message) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $message when calling FfI20240320Error., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($message) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message when calling FfI20240320Error., must be bigger than or equal to 1.');
        }
