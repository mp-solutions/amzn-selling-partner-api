<?php
/**
 * FfI20240320UpdateItemComplianceDetailsRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FfI20240320UpdateItemComplianceDetailsRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320UpdateItemComplianceDetailsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setMsku($msku)
    {
        if ((mb_strlen($msku) > 40)) {
            throw new \InvalidArgumentException('invalid length for $msku when calling FfI20240320UpdateItemComplianceDetailsRequest., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($msku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $msku when calling FfI20240320UpdateItemComplianceDetailsRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets tax_details
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320TaxDetails
     */
     ...
     * Sets tax_details
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320TaxDetails $tax_details tax_details
     *
     * @return self
     */
