...
/**
 * FfI20240320AppointmentSlot Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320AppointmentSlot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'slot_id' => 'string',
        'slot_time' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320AppointmentSlotTime'
    ];
    ...
    public function setSlotId($slot_id)
    {
        if ((mb_strlen($slot_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $slot_id when calling FfI20240320AppointmentSlot., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($slot_id) < 38)) {
            throw new \InvalidArgumentException('invalid length for $slot_id when calling FfI20240320AppointmentSlot., must be bigger than or equal to 38.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $slot_id))) {
            throw new \InvalidArgumentException("invalid value for $slot_id when calling FfI20240320AppointmentSlot., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
     ...
     * Gets slot_time
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320AppointmentSlotTime
     */
     ...
     * Sets slot_time
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320AppointmentSlotTime $slot_time slot_time
     *
     * @return self
     */
