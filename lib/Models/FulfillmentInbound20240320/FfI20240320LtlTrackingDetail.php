...
/**
 * FfI20240320LtlTrackingDetail Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320LtlTrackingDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setBillOfLadingNumber($bill_of_lading_number)
    {
        if (!is_null($bill_of_lading_number) && (mb_strlen($bill_of_lading_number) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $bill_of_lading_number when calling FfI20240320LtlTrackingDetail., must be smaller than or equal to 1024.');
        }
        if (!is_null($bill_of_lading_number) && (mb_strlen($bill_of_lading_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $bill_of_lading_number when calling FfI20240320LtlTrackingDetail., must be bigger than or equal to 1.');
        }
