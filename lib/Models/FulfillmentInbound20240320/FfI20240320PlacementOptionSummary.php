<?php
/**
 * FfI20240320PlacementOptionSummary
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FfI20240320PlacementOptionSummary Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320PlacementOptionSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PlacementOptionSummary';
    ...
    public function setPlacementOptionId($placement_option_id)
    {
        if ((mb_strlen($placement_option_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $placement_option_id when calling FfI20240320PlacementOptionSummary., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($placement_option_id) < 38)) {
            throw new \InvalidArgumentException('invalid length for $placement_option_id when calling FfI20240320PlacementOptionSummary., must be bigger than or equal to 38.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $placement_option_id))) {
            throw new \InvalidArgumentException("invalid value for $placement_option_id when calling FfI20240320PlacementOptionSummary., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $status when calling FfI20240320PlacementOptionSummary., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling FfI20240320PlacementOptionSummary., must be bigger than or equal to 1.');
        }
