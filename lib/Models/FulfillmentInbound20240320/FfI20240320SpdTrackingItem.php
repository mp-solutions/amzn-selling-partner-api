...
/**
 * FfI20240320SpdTrackingItem Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320SpdTrackingItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setBoxId($box_id)
    {
        if (!is_null($box_id) && (mb_strlen($box_id) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $box_id when calling FfI20240320SpdTrackingItem., must be smaller than or equal to 1024.');
        }
        if (!is_null($box_id) && (mb_strlen($box_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $box_id when calling FfI20240320SpdTrackingItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTrackingId($tracking_id)
    {
        if (!is_null($tracking_id) && (mb_strlen($tracking_id) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $tracking_id when calling FfI20240320SpdTrackingItem., must be smaller than or equal to 1024.');
        }
        if (!is_null($tracking_id) && (mb_strlen($tracking_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tracking_id when calling FfI20240320SpdTrackingItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTrackingNumberValidationStatus($tracking_number_validation_status)
    {
        if (!is_null($tracking_number_validation_status) && (mb_strlen($tracking_number_validation_status) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $tracking_number_validation_status when calling FfI20240320SpdTrackingItem., must be smaller than or equal to 1024.');
        }
        if (!is_null($tracking_number_validation_status) && (mb_strlen($tracking_number_validation_status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tracking_number_validation_status when calling FfI20240320SpdTrackingItem., must be bigger than or equal to 1.');
        }
