...
/**
 * FfI20240320CreateInboundPlanRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320CreateInboundPlanRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'source_address' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320AddressInput'
    ];
    ...
    public function setDestinationMarketplaces($destination_marketplaces)
    {
        ...
        if ((count($destination_marketplaces) > 1)) {
            throw new \InvalidArgumentException('invalid value for $destination_marketplaces when calling FfI20240320CreateInboundPlanRequest., number of items must be less than or equal to 1.');
        }
        if ((count($destination_marketplaces) < 1)) {
            throw new \InvalidArgumentException('invalid length for $destination_marketplaces when calling FfI20240320CreateInboundPlanRequest., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets items
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320ItemInput[] $items Items included in this plan.
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) > 2000)) {
            throw new \InvalidArgumentException('invalid value for $items when calling FfI20240320CreateInboundPlanRequest., number of items must be less than or equal to 2000.');
        }
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling FfI20240320CreateInboundPlanRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FfI20240320CreateInboundPlanRequest., must be smaller than or equal to 40.');
        }
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FfI20240320CreateInboundPlanRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets source_address
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320AddressInput
     */
     ...
     * Sets source_address
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320AddressInput $source_address source_address
     *
     * @return self
     */
