<?php
/**
 * FfI20240320PackingOptionSummary
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FfI20240320PackingOptionSummary Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320PackingOptionSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPackingOptionId($packing_option_id)
    {
        if ((mb_strlen($packing_option_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $packing_option_id when calling FfI20240320PackingOptionSummary., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($packing_option_id) < 38)) {
            throw new \InvalidArgumentException('invalid length for $packing_option_id when calling FfI20240320PackingOptionSummary., must be bigger than or equal to 38.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $packing_option_id))) {
            throw new \InvalidArgumentException("invalid value for $packing_option_id when calling FfI20240320PackingOptionSummary., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $status when calling FfI20240320PackingOptionSummary., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling FfI20240320PackingOptionSummary., must be bigger than or equal to 1.');
        }
