...
/**
 * FfI20240320CreateMarketplaceItemLabelsRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320CreateMarketplaceItemLabelsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'height' => 'float',
        'label_type' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320LabelPrintType',
        'locale_code' => 'string',
        'marketplace_id' => 'string',
        'msku_quantities' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320MskuQuantity[]',
        'page_type' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320ItemLabelPageType',
        'width' => 'float'
    ];
    ...
    public function setHeight($height)
    {
        ...
        if (!is_null($height) && ($height > 1E+2)) {
            throw new \InvalidArgumentException('invalid value for $height when calling FfI20240320CreateMarketplaceItemLabelsRequest., must be smaller than or equal to 1E+2.');
        }
        if (!is_null($height) && ($height < 25)) {
            throw new \InvalidArgumentException('invalid value for $height when calling FfI20240320CreateMarketplaceItemLabelsRequest., must be bigger than or equal to 25.');
        }
     ...
     * Gets label_type
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320LabelPrintType
     */
     ...
     * Sets label_type
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320LabelPrintType $label_type label_type
     *
     * @return self
     */
    ...
    public function setLocaleCode($locale_code)
    {
        ...
        if (!is_null($locale_code) && (!preg_match("/^[a-z]{2}_[A-Z]{2}$/", $locale_code))) {
            throw new \InvalidArgumentException("invalid value for $locale_code when calling FfI20240320CreateMarketplaceItemLabelsRequest., must conform to the pattern /^[a-z]{2}_[A-Z]{2}$/.");
        }
    ...
    public function setMarketplaceId($marketplace_id)
    {
        if ((mb_strlen($marketplace_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $marketplace_id when calling FfI20240320CreateMarketplaceItemLabelsRequest., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($marketplace_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $marketplace_id when calling FfI20240320CreateMarketplaceItemLabelsRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320MskuQuantity[]
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320MskuQuantity[] $msku_quantities Represents the quantity of an MSKU to print item labels for.
     *
     * @return self
     */
    public function setMskuQuantities($msku_quantities)
    {
        ...
        if ((count($msku_quantities) > 100)) {
            throw new \InvalidArgumentException('invalid value for $msku_quantities when calling FfI20240320CreateMarketplaceItemLabelsRequest., number of items must be less than or equal to 100.');
        }
        if ((count($msku_quantities) < 1)) {
            throw new \InvalidArgumentException('invalid length for $msku_quantities when calling FfI20240320CreateMarketplaceItemLabelsRequest., number of items must be greater than or equal to 1.');
        }
     ...
     * Gets page_type
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320ItemLabelPageType|null
     */
     ...
     * Sets page_type
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320ItemLabelPageType|null $page_type page_type
     *
     * @return self
     */
    ...
    public function setWidth($width)
    {
        ...
        if (!is_null($width) && ($width > 1E+2)) {
            throw new \InvalidArgumentException('invalid value for $width when calling FfI20240320CreateMarketplaceItemLabelsRequest., must be smaller than or equal to 1E+2.');
        }
        if (!is_null($width) && ($width < 25)) {
            throw new \InvalidArgumentException('invalid value for $width when calling FfI20240320CreateMarketplaceItemLabelsRequest., must be bigger than or equal to 25.');
        }
