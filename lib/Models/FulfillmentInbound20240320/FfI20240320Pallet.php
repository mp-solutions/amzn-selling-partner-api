...
/**
 * FfI20240320Pallet Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320Pallet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'package_id' => 'string',
        'quantity' => 'int',
        'stackability' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Stackability',
    ...
    public function setPackageId($package_id)
    {
        if ((mb_strlen($package_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $package_id when calling FfI20240320Pallet., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($package_id) < 38)) {
            throw new \InvalidArgumentException('invalid length for $package_id when calling FfI20240320Pallet., must be bigger than or equal to 38.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $package_id))) {
            throw new \InvalidArgumentException("invalid value for $package_id when calling FfI20240320Pallet., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity > 10000)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling FfI20240320Pallet., must be smaller than or equal to 10000.');
        }
        if (!is_null($quantity) && ($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling FfI20240320Pallet., must be bigger than or equal to 1.');
        }
     ...
     * Gets stackability
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Stackability|null
     */
     ...
     * Sets stackability
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Stackability|null $stackability stackability
     *
     * @return self
     */
