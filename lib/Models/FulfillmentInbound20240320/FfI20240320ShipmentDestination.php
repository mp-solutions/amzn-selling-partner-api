<?php
/**
 * FfI20240320ShipmentDestination
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FfI20240320ShipmentDestination Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320ShipmentDestination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'address' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Address',
     ...
     * Gets address
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Address|null
     */
     ...
     * Sets address
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Address|null $address address
     *
     * @return self
     */
    ...
    public function setDestinationType($destination_type)
    {
        if ((mb_strlen($destination_type) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $destination_type when calling FfI20240320ShipmentDestination., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($destination_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $destination_type when calling FfI20240320ShipmentDestination., must be bigger than or equal to 1.');
        }
    ...
    public function setWarehouseId($warehouse_id)
    {
        if (!is_null($warehouse_id) && (mb_strlen($warehouse_id) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling FfI20240320ShipmentDestination., must be smaller than or equal to 1024.');
        }
        if (!is_null($warehouse_id) && (mb_strlen($warehouse_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling FfI20240320ShipmentDestination., must be bigger than or equal to 1.');
        }
