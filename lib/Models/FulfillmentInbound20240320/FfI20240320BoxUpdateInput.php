...
/**
 * FfI20240320BoxUpdateInput Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320BoxUpdateInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320ItemInput[]',
        'package_id' => 'string',
        'quantity' => 'int',
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320BoxContentInformationSource
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320BoxContentInformationSource $content_information_source content_information_source
     *
     * @return self
     */
     ...
     * Gets dimensions
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Dimensions
     */
     ...
     * Sets dimensions
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Dimensions $dimensions dimensions
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320ItemInput[]|null
     */
     ...
     * Sets items
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320ItemInput[]|null $items The items and their quantity in the box. This must be empty if the box `contentInformationSource` is `BARCODE_2D` or `MANUAL_PROCESS`.
     *
     * @return self
     */
    ...
    public function setPackageId($package_id)
    {
        if (!is_null($package_id) && (mb_strlen($package_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $package_id when calling FfI20240320BoxUpdateInput., must be smaller than or equal to 38.');
        }
        if (!is_null($package_id) && (mb_strlen($package_id) < 38)) {
            throw new \InvalidArgumentException('invalid length for $package_id when calling FfI20240320BoxUpdateInput., must be bigger than or equal to 38.');
        }
        if (!is_null($package_id) && (!preg_match("/^[a-zA-Z0-9-]*$/", $package_id))) {
            throw new \InvalidArgumentException("invalid value for $package_id when calling FfI20240320BoxUpdateInput., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 10000)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling FfI20240320BoxUpdateInput., must be smaller than or equal to 10000.');
        }
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling FfI20240320BoxUpdateInput., must be bigger than or equal to 1.');
        }
     ...
     * Gets weight
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Weight
     */
     ...
     * Sets weight
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Weight $weight weight
     *
     * @return self
     */
