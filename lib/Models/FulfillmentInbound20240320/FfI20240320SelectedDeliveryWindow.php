<?php
/**
 * FfI20240320SelectedDeliveryWindow
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FfI20240320SelectedDeliveryWindow Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320SelectedDeliveryWindow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setDeliveryWindowOptionId($delivery_window_option_id)
    {
        if ((mb_strlen($delivery_window_option_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $delivery_window_option_id when calling FfI20240320SelectedDeliveryWindow., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($delivery_window_option_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $delivery_window_option_id when calling FfI20240320SelectedDeliveryWindow., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $delivery_window_option_id))) {
            throw new \InvalidArgumentException("invalid value for $delivery_window_option_id when calling FfI20240320SelectedDeliveryWindow., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
