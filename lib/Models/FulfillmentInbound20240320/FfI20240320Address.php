...
/**
 * FfI20240320Address Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setAddressLine1($address_line1)
    {
        if ((mb_strlen($address_line1) > 180)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling FfI20240320Address., must be smaller than or equal to 180.');
        }
        if ((mb_strlen($address_line1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling FfI20240320Address., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressLine2($address_line2)
    {
        if (!is_null($address_line2) && (mb_strlen($address_line2) > 60)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling FfI20240320Address., must be smaller than or equal to 60.');
        }
        if (!is_null($address_line2) && (mb_strlen($address_line2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling FfI20240320Address., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        if ((mb_strlen($city) > 30)) {
            throw new \InvalidArgumentException('invalid length for $city when calling FfI20240320Address., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling FfI20240320Address., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyName($company_name)
    {
        if (!is_null($company_name) && (mb_strlen($company_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling FfI20240320Address., must be smaller than or equal to 50.');
        }
        if (!is_null($company_name) && (mb_strlen($company_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling FfI20240320Address., must be bigger than or equal to 1.');
        }
    ...
    public function setCountryCode($country_code)
    {
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling FfI20240320Address., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling FfI20240320Address., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[A-Z]{2}$/", $country_code))) {
            throw new \InvalidArgumentException("invalid value for $country_code when calling FfI20240320Address., must conform to the pattern /^[A-Z]{2}$/.");
        }
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $email when calling FfI20240320Address., must be smaller than or equal to 1024.');
        }
        if (!is_null($email) && (mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling FfI20240320Address., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FfI20240320Address., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FfI20240320Address., must be bigger than or equal to 1.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling FfI20240320Address., must be smaller than or equal to 20.');
        }
        if (!is_null($phone_number) && (mb_strlen($phone_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling FfI20240320Address., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        if ((mb_strlen($postal_code) > 32)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling FfI20240320Address., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($postal_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling FfI20240320Address., must be bigger than or equal to 1.');
        }
    ...
    public function setStateOrProvinceCode($state_or_province_code)
    {
        if (!is_null($state_or_province_code) && (mb_strlen($state_or_province_code) > 64)) {
            throw new \InvalidArgumentException('invalid length for $state_or_province_code when calling FfI20240320Address., must be smaller than or equal to 64.');
        }
        if (!is_null($state_or_province_code) && (mb_strlen($state_or_province_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state_or_province_code when calling FfI20240320Address., must be bigger than or equal to 1.');
        }
