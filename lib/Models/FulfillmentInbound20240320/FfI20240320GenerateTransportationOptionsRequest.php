<?php
/**
 * FfI20240320GenerateTransportationOptionsRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FfI20240320GenerateTransportationOptionsRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320GenerateTransportationOptionsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'shipment_transportation_configurations' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320ShipmentTransportationConfiguration[]'
    ];
    ...
    public function setPlacementOptionId($placement_option_id)
    {
        if ((mb_strlen($placement_option_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $placement_option_id when calling FfI20240320GenerateTransportationOptionsRequest., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($placement_option_id) < 38)) {
            throw new \InvalidArgumentException('invalid length for $placement_option_id when calling FfI20240320GenerateTransportationOptionsRequest., must be bigger than or equal to 38.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $placement_option_id))) {
            throw new \InvalidArgumentException("invalid value for $placement_option_id when calling FfI20240320GenerateTransportationOptionsRequest., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320ShipmentTransportationConfiguration[]
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320ShipmentTransportationConfiguration[] $shipment_transportation_configurations List of shipment transportation configurations.
     *
     * @return self
     */
    public function setShipmentTransportationConfigurations($shipment_transportation_configurations)
    {
        ...
        if ((count($shipment_transportation_configurations) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shipment_transportation_configurations when calling FfI20240320GenerateTransportationOptionsRequest., number of items must be greater than or equal to 1.');
        }
