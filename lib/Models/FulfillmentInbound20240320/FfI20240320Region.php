...
/**
 * FfI20240320Region Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320Region implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCountryCode($country_code)
    {
        if (!is_null($country_code) && (mb_strlen($country_code) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling FfI20240320Region., must be smaller than or equal to 1024.');
        }
        if (!is_null($country_code) && (mb_strlen($country_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling FfI20240320Region., must be bigger than or equal to 1.');
        }
    ...
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $state when calling FfI20240320Region., must be smaller than or equal to 1024.');
        }
        if (!is_null($state) && (mb_strlen($state) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state when calling FfI20240320Region., must be bigger than or equal to 1.');
        }
    ...
    public function setWarehouseId($warehouse_id)
    {
        if (!is_null($warehouse_id) && (mb_strlen($warehouse_id) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling FfI20240320Region., must be smaller than or equal to 1024.');
        }
        if (!is_null($warehouse_id) && (mb_strlen($warehouse_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling FfI20240320Region., must be bigger than or equal to 1.');
        }
