...
/**
 * FfI20240320Currency Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320Currency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        if ((mb_strlen($code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling FfI20240320Currency., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling FfI20240320Currency., must be bigger than or equal to 3.');
        }
