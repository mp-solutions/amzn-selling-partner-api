...
/**
 * FfI20240320TaxRate Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320TaxRate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setTaxType($tax_type)
    {
        if (!is_null($tax_type) && (mb_strlen($tax_type) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $tax_type when calling FfI20240320TaxRate., must be smaller than or equal to 1024.');
        }
        if (!is_null($tax_type) && (mb_strlen($tax_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tax_type when calling FfI20240320TaxRate., must be bigger than or equal to 1.');
        }
