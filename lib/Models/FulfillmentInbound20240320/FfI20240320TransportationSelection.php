<?php
/**
 * FfI20240320TransportationSelection
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FfI20240320TransportationSelection Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320TransportationSelection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setShipmentId($shipment_id)
    {
        if ((mb_strlen($shipment_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $shipment_id when calling FfI20240320TransportationSelection., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($shipment_id) < 38)) {
            throw new \InvalidArgumentException('invalid length for $shipment_id when calling FfI20240320TransportationSelection., must be bigger than or equal to 38.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $shipment_id))) {
            throw new \InvalidArgumentException("invalid value for $shipment_id when calling FfI20240320TransportationSelection., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
    ...
    public function setTransportationOptionId($transportation_option_id)
    {
        if ((mb_strlen($transportation_option_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $transportation_option_id when calling FfI20240320TransportationSelection., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($transportation_option_id) < 38)) {
            throw new \InvalidArgumentException('invalid length for $transportation_option_id when calling FfI20240320TransportationSelection., must be bigger than or equal to 38.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $transportation_option_id))) {
            throw new \InvalidArgumentException("invalid value for $transportation_option_id when calling FfI20240320TransportationSelection., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
