...
/**
 * FfI20240320TaxDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320TaxDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'hsn_code' => 'string',
        'tax_rates' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320TaxRate[]'
    ];
    ...
    public function setHsnCode($hsn_code)
    {
        if (!is_null($hsn_code) && (mb_strlen($hsn_code) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $hsn_code when calling FfI20240320TaxDetails., must be smaller than or equal to 1024.');
        }
        if (!is_null($hsn_code) && (mb_strlen($hsn_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $hsn_code when calling FfI20240320TaxDetails., must be bigger than or equal to 1.');
        }
     ...
     * Gets tax_rates
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320TaxRate[]|null
     */
     ...
     * Sets tax_rates
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320TaxRate[]|null $tax_rates List of tax rates.
     *
     * @return self
     */
