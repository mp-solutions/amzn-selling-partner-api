...
/**
 * FfI20240320PalletInput Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320PalletInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PalletInput';
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 10000)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling FfI20240320PalletInput., must be smaller than or equal to 10000.');
        }
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling FfI20240320PalletInput., must be bigger than or equal to 1.');
        }
