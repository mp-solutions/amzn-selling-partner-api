...
/**
 * FfI20240320BoxInput Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320BoxInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 10000)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling FfI20240320BoxInput., must be smaller than or equal to 10000.');
        }
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling FfI20240320BoxInput., must be bigger than or equal to 1.');
        }
