...
/**
 * FfI20240320ItemInput Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320ItemInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'expiration' => 'string',
        'label_owner' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320LabelOwner',
        'manufacturing_lot_code' => 'string',
        'msku' => 'string',
        'prep_owner' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320PrepOwner',
        'quantity' => 'int'
    ];
    ...
    public function setExpiration($expiration)
    {
        ...
        if (!is_null($expiration) && (!preg_match("/^([0-9]{4})-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/", $expiration))) {
            throw new \InvalidArgumentException("invalid value for $expiration when calling FfI20240320ItemInput., must conform to the pattern /^([0-9]{4})-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
        }
     ...
     * Gets label_owner
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320LabelOwner
     */
     ...
     * Sets label_owner
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320LabelOwner $label_owner label_owner
     *
     * @return self
     */
    ...
    public function setManufacturingLotCode($manufacturing_lot_code)
    {
        if (!is_null($manufacturing_lot_code) && (mb_strlen($manufacturing_lot_code) > 256)) {
            throw new \InvalidArgumentException('invalid length for $manufacturing_lot_code when calling FfI20240320ItemInput., must be smaller than or equal to 256.');
        }
        if (!is_null($manufacturing_lot_code) && (mb_strlen($manufacturing_lot_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $manufacturing_lot_code when calling FfI20240320ItemInput., must be bigger than or equal to 1.');
        }
    ...
    public function setMsku($msku)
    {
        if ((mb_strlen($msku) > 40)) {
            throw new \InvalidArgumentException('invalid length for $msku when calling FfI20240320ItemInput., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($msku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $msku when calling FfI20240320ItemInput., must be bigger than or equal to 1.');
        }
     ...
     * Gets prep_owner
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320PrepOwner
     */
     ...
     * Sets prep_owner
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320PrepOwner $prep_owner prep_owner
     *
     * @return self
     */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 10000)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling FfI20240320ItemInput., must be smaller than or equal to 10000.');
        }
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling FfI20240320ItemInput., must be bigger than or equal to 1.');
        }
