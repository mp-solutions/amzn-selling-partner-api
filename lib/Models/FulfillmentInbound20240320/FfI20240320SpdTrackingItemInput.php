<?php
/**
 * FfI20240320SpdTrackingItemInput
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FfI20240320SpdTrackingItemInput Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320SpdTrackingItemInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setBoxId($box_id)
    {
        if ((mb_strlen($box_id) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $box_id when calling FfI20240320SpdTrackingItemInput., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($box_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $box_id when calling FfI20240320SpdTrackingItemInput., must be bigger than or equal to 1.');
        }
    ...
    public function setTrackingId($tracking_id)
    {
        if ((mb_strlen($tracking_id) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $tracking_id when calling FfI20240320SpdTrackingItemInput., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($tracking_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tracking_id when calling FfI20240320SpdTrackingItemInput., must be bigger than or equal to 1.');
        }
