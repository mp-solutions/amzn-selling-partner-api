...
/**
 * FfI20240320SetPrepDetailsResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320SetPrepDetailsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetPrepDetailsResponse';
    ...
    public function setOperationId($operation_id)
    {
        if ((mb_strlen($operation_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $operation_id when calling FfI20240320SetPrepDetailsResponse., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($operation_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $operation_id when calling FfI20240320SetPrepDetailsResponse., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $operation_id))) {
            throw new \InvalidArgumentException("invalid value for $operation_id when calling FfI20240320SetPrepDetailsResponse., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
