...
/**
 * FfI20240320PackageGroupingInput Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320PackageGroupingInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'boxes' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320BoxInput[]',
     ...
     * Gets boxes
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320BoxInput[]
     */
     ...
     * Sets boxes
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320BoxInput[] $boxes Box level information being provided.
     *
     * @return self
     */
    public function setBoxes($boxes)
    {
        ...
        if ((count($boxes) > 5000)) {
            throw new \InvalidArgumentException('invalid value for $boxes when calling FfI20240320PackageGroupingInput., number of items must be less than or equal to 5000.');
        }
        if ((count($boxes) < 1)) {
            throw new \InvalidArgumentException('invalid length for $boxes when calling FfI20240320PackageGroupingInput., number of items must be greater than or equal to 1.');
        }
    ...
    public function setPackingGroupId($packing_group_id)
    {
        if (!is_null($packing_group_id) && (mb_strlen($packing_group_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $packing_group_id when calling FfI20240320PackageGroupingInput., must be smaller than or equal to 38.');
        }
        if (!is_null($packing_group_id) && (mb_strlen($packing_group_id) < 38)) {
            throw new \InvalidArgumentException('invalid length for $packing_group_id when calling FfI20240320PackageGroupingInput., must be bigger than or equal to 38.');
        }
        if (!is_null($packing_group_id) && (!preg_match("/^[a-zA-Z0-9-]*$/", $packing_group_id))) {
            throw new \InvalidArgumentException("invalid value for $packing_group_id when calling FfI20240320PackageGroupingInput., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
    ...
    public function setShipmentId($shipment_id)
    {
        if (!is_null($shipment_id) && (mb_strlen($shipment_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $shipment_id when calling FfI20240320PackageGroupingInput., must be smaller than or equal to 38.');
        }
        if (!is_null($shipment_id) && (mb_strlen($shipment_id) < 38)) {
            throw new \InvalidArgumentException('invalid length for $shipment_id when calling FfI20240320PackageGroupingInput., must be bigger than or equal to 38.');
        }
        if (!is_null($shipment_id) && (!preg_match("/^[a-zA-Z0-9-]*$/", $shipment_id))) {
            throw new \InvalidArgumentException("invalid value for $shipment_id when calling FfI20240320PackageGroupingInput., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
