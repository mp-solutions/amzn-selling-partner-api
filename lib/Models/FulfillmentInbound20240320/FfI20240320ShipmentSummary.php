...
/**
 * FfI20240320ShipmentSummary Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320ShipmentSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setShipmentId($shipment_id)
    {
        if ((mb_strlen($shipment_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $shipment_id when calling FfI20240320ShipmentSummary., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($shipment_id) < 38)) {
            throw new \InvalidArgumentException('invalid length for $shipment_id when calling FfI20240320ShipmentSummary., must be bigger than or equal to 38.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $shipment_id))) {
            throw new \InvalidArgumentException("invalid value for $shipment_id when calling FfI20240320ShipmentSummary., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $status when calling FfI20240320ShipmentSummary., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling FfI20240320ShipmentSummary., must be bigger than or equal to 1.');
        }
