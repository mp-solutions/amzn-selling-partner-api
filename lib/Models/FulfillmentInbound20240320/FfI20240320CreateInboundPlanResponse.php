<?php
/**
 * FfI20240320CreateInboundPlanResponse
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FfI20240320CreateInboundPlanResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320CreateInboundPlanResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setInboundPlanId($inbound_plan_id)
    {
        if ((mb_strlen($inbound_plan_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $inbound_plan_id when calling FfI20240320CreateInboundPlanResponse., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($inbound_plan_id) < 38)) {
            throw new \InvalidArgumentException('invalid length for $inbound_plan_id when calling FfI20240320CreateInboundPlanResponse., must be bigger than or equal to 38.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $inbound_plan_id))) {
            throw new \InvalidArgumentException("invalid value for $inbound_plan_id when calling FfI20240320CreateInboundPlanResponse., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
    ...
    public function setOperationId($operation_id)
    {
        if ((mb_strlen($operation_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $operation_id when calling FfI20240320CreateInboundPlanResponse., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($operation_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $operation_id when calling FfI20240320CreateInboundPlanResponse., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $operation_id))) {
            throw new \InvalidArgumentException("invalid value for $operation_id when calling FfI20240320CreateInboundPlanResponse., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
