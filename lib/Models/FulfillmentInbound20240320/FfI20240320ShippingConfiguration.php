<?php
/**
 * FfI20240320ShippingConfiguration
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FfI20240320ShippingConfiguration Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320ShippingConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setShippingMode($shipping_mode)
    {
        if (!is_null($shipping_mode) && (mb_strlen($shipping_mode) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $shipping_mode when calling FfI20240320ShippingConfiguration., must be smaller than or equal to 1024.');
        }
        if (!is_null($shipping_mode) && (mb_strlen($shipping_mode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shipping_mode when calling FfI20240320ShippingConfiguration., must be bigger than or equal to 1.');
        }
    ...
    public function setShippingSolution($shipping_solution)
    {
        if (!is_null($shipping_solution) && (mb_strlen($shipping_solution) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $shipping_solution when calling FfI20240320ShippingConfiguration., must be smaller than or equal to 1024.');
        }
        if (!is_null($shipping_solution) && (mb_strlen($shipping_solution) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shipping_solution when calling FfI20240320ShippingConfiguration., must be bigger than or equal to 1.');
        }
