<?php
/**
 * FfI20240320MskuPrepDetailInput
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FfI20240320MskuPrepDetailInput Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320MskuPrepDetailInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setMsku($msku)
    {
        if ((mb_strlen($msku) > 40)) {
            throw new \InvalidArgumentException('invalid length for $msku when calling FfI20240320MskuPrepDetailInput., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($msku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $msku when calling FfI20240320MskuPrepDetailInput., must be bigger than or equal to 1.');
        }
