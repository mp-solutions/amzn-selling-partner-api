...
/**
 * FfI20240320PlacementOption Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320PlacementOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets fees
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Incentive[] $fees The fee for the offered option.
     *
     * @return self
     */
    ...
    public function setPlacementOptionId($placement_option_id)
    {
        if ((mb_strlen($placement_option_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $placement_option_id when calling FfI20240320PlacementOption., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($placement_option_id) < 38)) {
            throw new \InvalidArgumentException('invalid length for $placement_option_id when calling FfI20240320PlacementOption., must be bigger than or equal to 38.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $placement_option_id))) {
            throw new \InvalidArgumentException("invalid value for $placement_option_id when calling FfI20240320PlacementOption., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $status when calling FfI20240320PlacementOption., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling FfI20240320PlacementOption., must be bigger than or equal to 1.');
        }
