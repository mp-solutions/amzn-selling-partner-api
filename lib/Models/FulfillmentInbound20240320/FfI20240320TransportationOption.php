...
/**
 * FfI20240320TransportationOption Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320TransportationOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'carrier' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Carrier',
        'carrier_appointment' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320CarrierAppointment',
        'preconditions' => 'string[]',
        'quote' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Quote',
        'shipment_id' => 'string',
     ...
     * Gets carrier
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Carrier
     */
     ...
     * Sets carrier
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Carrier $carrier carrier
     *
     * @return self
     */
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320CarrierAppointment|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320CarrierAppointment|null $carrier_appointment carrier_appointment
     *
     * @return self
     */
     ...
     * Gets quote
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Quote|null
     */
     ...
     * Sets quote
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320Quote|null $quote quote
     *
     * @return self
     */
    ...
    public function setShipmentId($shipment_id)
    {
        if ((mb_strlen($shipment_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $shipment_id when calling FfI20240320TransportationOption., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($shipment_id) < 38)) {
            throw new \InvalidArgumentException('invalid length for $shipment_id when calling FfI20240320TransportationOption., must be bigger than or equal to 38.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $shipment_id))) {
            throw new \InvalidArgumentException("invalid value for $shipment_id when calling FfI20240320TransportationOption., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
    ...
    public function setShippingMode($shipping_mode)
    {
        if ((mb_strlen($shipping_mode) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $shipping_mode when calling FfI20240320TransportationOption., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($shipping_mode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shipping_mode when calling FfI20240320TransportationOption., must be bigger than or equal to 1.');
        }
    ...
    public function setShippingSolution($shipping_solution)
    {
        if ((mb_strlen($shipping_solution) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $shipping_solution when calling FfI20240320TransportationOption., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($shipping_solution) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shipping_solution when calling FfI20240320TransportationOption., must be bigger than or equal to 1.');
        }
    ...
    public function setTransportationOptionId($transportation_option_id)
    {
        if ((mb_strlen($transportation_option_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $transportation_option_id when calling FfI20240320TransportationOption., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($transportation_option_id) < 38)) {
            throw new \InvalidArgumentException('invalid length for $transportation_option_id when calling FfI20240320TransportationOption., must be bigger than or equal to 38.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $transportation_option_id))) {
            throw new \InvalidArgumentException("invalid value for $transportation_option_id when calling FfI20240320TransportationOption., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
