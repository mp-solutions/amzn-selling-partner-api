...
/**
 * FfI20240320ComplianceDetail Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320ComplianceDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'fnsku' => 'string',
        'msku' => 'string',
        'tax_details' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320TaxDetails'
    ];
    ...
    public function setAsin($asin)
    {
        if (!is_null($asin) && (mb_strlen($asin) > 10)) {
            throw new \InvalidArgumentException('invalid length for $asin when calling FfI20240320ComplianceDetail., must be smaller than or equal to 10.');
        }
        if (!is_null($asin) && (mb_strlen($asin) < 1)) {
            throw new \InvalidArgumentException('invalid length for $asin when calling FfI20240320ComplianceDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setFnsku($fnsku)
    {
        if (!is_null($fnsku) && (mb_strlen($fnsku) > 10)) {
            throw new \InvalidArgumentException('invalid length for $fnsku when calling FfI20240320ComplianceDetail., must be smaller than or equal to 10.');
        }
        if (!is_null($fnsku) && (mb_strlen($fnsku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $fnsku when calling FfI20240320ComplianceDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setMsku($msku)
    {
        if (!is_null($msku) && (mb_strlen($msku) > 40)) {
            throw new \InvalidArgumentException('invalid length for $msku when calling FfI20240320ComplianceDetail., must be smaller than or equal to 40.');
        }
        if (!is_null($msku) && (mb_strlen($msku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $msku when calling FfI20240320ComplianceDetail., must be bigger than or equal to 1.');
        }
     ...
     * Gets tax_details
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320TaxDetails|null
     */
     ...
     * Sets tax_details
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320TaxDetails|null $tax_details tax_details
     *
     * @return self
     */
