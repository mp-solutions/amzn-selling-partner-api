...
/**
 * FfI20240320InboundPlanSummary Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320InboundPlanSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setInboundPlanId($inbound_plan_id)
    {
        if ((mb_strlen($inbound_plan_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $inbound_plan_id when calling FfI20240320InboundPlanSummary., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($inbound_plan_id) < 38)) {
            throw new \InvalidArgumentException('invalid length for $inbound_plan_id when calling FfI20240320InboundPlanSummary., must be bigger than or equal to 38.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $inbound_plan_id))) {
            throw new \InvalidArgumentException("invalid value for $inbound_plan_id when calling FfI20240320InboundPlanSummary., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $status when calling FfI20240320InboundPlanSummary., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling FfI20240320InboundPlanSummary., must be bigger than or equal to 1.');
        }
