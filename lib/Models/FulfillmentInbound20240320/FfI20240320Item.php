...
/**
 * FfI20240320Item Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320Item implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'msku' => 'string',
        'prep_instructions' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320PrepInstruction[]',
        'quantity' => 'int'
    ];
    ...
    public function setAsin($asin)
    {
        if ((mb_strlen($asin) > 10)) {
            throw new \InvalidArgumentException('invalid length for $asin when calling FfI20240320Item., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($asin) < 1)) {
            throw new \InvalidArgumentException('invalid length for $asin when calling FfI20240320Item., must be bigger than or equal to 1.');
        }
    ...
    public function setExpiration($expiration)
    {
        ...
        if (!is_null($expiration) && (!preg_match("/^([0-9]{4})-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/", $expiration))) {
            throw new \InvalidArgumentException("invalid value for $expiration when calling FfI20240320Item., must conform to the pattern /^([0-9]{4})-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
        }
    ...
    public function setFnsku($fnsku)
    {
        if ((mb_strlen($fnsku) > 10)) {
            throw new \InvalidArgumentException('invalid length for $fnsku when calling FfI20240320Item., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($fnsku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $fnsku when calling FfI20240320Item., must be bigger than or equal to 1.');
        }
    ...
    public function setLabelOwner($label_owner)
    {
        if ((mb_strlen($label_owner) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $label_owner when calling FfI20240320Item., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($label_owner) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label_owner when calling FfI20240320Item., must be bigger than or equal to 1.');
        }
    ...
    public function setManufacturingLotCode($manufacturing_lot_code)
    {
        if (!is_null($manufacturing_lot_code) && (mb_strlen($manufacturing_lot_code) > 256)) {
            throw new \InvalidArgumentException('invalid length for $manufacturing_lot_code when calling FfI20240320Item., must be smaller than or equal to 256.');
        }
        if (!is_null($manufacturing_lot_code) && (mb_strlen($manufacturing_lot_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $manufacturing_lot_code when calling FfI20240320Item., must be bigger than or equal to 1.');
        }
    ...
    public function setMsku($msku)
    {
        if ((mb_strlen($msku) > 40)) {
            throw new \InvalidArgumentException('invalid length for $msku when calling FfI20240320Item., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($msku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $msku when calling FfI20240320Item., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320PrepInstruction[]
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320PrepInstruction[] $prep_instructions Special preparations that are required for an item.
     *
     * @return self
     */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 10000)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling FfI20240320Item., must be smaller than or equal to 10000.');
        }
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling FfI20240320Item., must be bigger than or equal to 1.');
        }
