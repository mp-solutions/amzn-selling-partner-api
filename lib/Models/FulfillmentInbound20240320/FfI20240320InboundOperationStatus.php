<?php
/**
 * FfI20240320InboundOperationStatus
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FfI20240320InboundOperationStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320InboundOperationStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'operation' => 'string',
        'operation_id' => 'string',
        'operation_problems' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320OperationProblem[]',
        'operation_status' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320OperationStatus'
    ];
    ...
    public function setOperation($operation)
    {
        if ((mb_strlen($operation) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $operation when calling FfI20240320InboundOperationStatus., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($operation) < 1)) {
            throw new \InvalidArgumentException('invalid length for $operation when calling FfI20240320InboundOperationStatus., must be bigger than or equal to 1.');
        }
    ...
    public function setOperationId($operation_id)
    {
        if ((mb_strlen($operation_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $operation_id when calling FfI20240320InboundOperationStatus., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($operation_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $operation_id when calling FfI20240320InboundOperationStatus., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $operation_id))) {
            throw new \InvalidArgumentException("invalid value for $operation_id when calling FfI20240320InboundOperationStatus., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320OperationProblem[]
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320OperationProblem[] $operation_problems The problems in the processing of the asynchronous operation.
     *
     * @return self
     */
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320OperationStatus
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320OperationStatus $operation_status operation_status
     *
     * @return self
     */
