...
/**
 * FfI20240320CancelSelfShipAppointmentResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320CancelSelfShipAppointmentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CancelSelfShipAppointmentResponse';
    ...
    public function setOperationId($operation_id)
    {
        if ((mb_strlen($operation_id) > 38)) {
            throw new \InvalidArgumentException('invalid length for $operation_id when calling FfI20240320CancelSelfShipAppointmentResponse., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($operation_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $operation_id when calling FfI20240320CancelSelfShipAppointmentResponse., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-]*$/", $operation_id))) {
            throw new \InvalidArgumentException("invalid value for $operation_id when calling FfI20240320CancelSelfShipAppointmentResponse., must conform to the pattern /^[a-zA-Z0-9-]*$/.");
        }
