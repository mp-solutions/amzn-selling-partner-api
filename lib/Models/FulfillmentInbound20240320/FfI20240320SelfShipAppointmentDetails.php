<?php
/**
 * FfI20240320SelfShipAppointmentDetails
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FfI20240320SelfShipAppointmentDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320SelfShipAppointmentDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'appointment_slot_time' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320AppointmentSlotTime',
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320AppointmentSlotTime|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320AppointmentSlotTime|null $appointment_slot_time appointment_slot_time
     *
     * @return self
     */
    ...
    public function setAppointmentStatus($appointment_status)
    {
        if (!is_null($appointment_status) && (mb_strlen($appointment_status) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $appointment_status when calling FfI20240320SelfShipAppointmentDetails., must be smaller than or equal to 1024.');
        }
        if (!is_null($appointment_status) && (mb_strlen($appointment_status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $appointment_status when calling FfI20240320SelfShipAppointmentDetails., must be bigger than or equal to 1.');
        }
