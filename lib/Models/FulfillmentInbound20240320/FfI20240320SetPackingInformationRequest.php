<?php
/**
 * FfI20240320SetPackingInformationRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FfI20240320SetPackingInformationRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class FfI20240320SetPackingInformationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'package_groupings' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320PackageGroupingInput[]'
    ];
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320PackageGroupingInput[]
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentInbound20240320\FfI20240320PackageGroupingInput[] $package_groupings List of packing information for the inbound plan.
     *
     * @return self
     */
    public function setPackageGroupings($package_groupings)
    {
        ...
        if ((count($package_groupings) < 1)) {
            throw new \InvalidArgumentException('invalid length for $package_groupings when calling FfI20240320SetPackingInformationRequest., number of items must be greater than or equal to 1.');
        }
