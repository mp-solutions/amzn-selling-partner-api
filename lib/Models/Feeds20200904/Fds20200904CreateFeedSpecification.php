...
/**
 * Fds20200904CreateFeedSpecification Class Doc Comment
 *
 * @category Class
 * @package  MPSolutions\AmznSellingPartnerApi
 * @author   OpenAPI Generator team
 ...
 */
class Fds20200904CreateFeedSpecification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setMarketplaceIds($marketplace_ids)
    {
        ...
        if ((count($marketplace_ids) > 25)) {
            throw new \InvalidArgumentException('invalid value for $marketplace_ids when calling Fds20200904CreateFeedSpecification., number of items must be less than or equal to 25.');
        }
        if ((count($marketplace_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $marketplace_ids when calling Fds20200904CreateFeedSpecification., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets feed_options
     *
     * @param array<string,string>|null $feed_options Additional options to control the feed. For feeds that use the feedOptions parameter, you can find the parameter values in the feed description in [feedType values](doc:feed-type-values).
     *
     * @return self
     */
