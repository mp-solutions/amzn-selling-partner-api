...
/**
 * Rpr20210630CreateReportSpecification Class Doc Comment
 *
 * @category Class
 ...
 */
class Rpr20210630CreateReportSpecification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setMarketplaceIds($marketplace_ids)
    {
        ...
        if ((count($marketplace_ids) > 25)) {
            throw new \InvalidArgumentException('invalid value for $marketplace_ids when calling Rpr20210630CreateReportSpecification., number of items must be less than or equal to 25.');
        }
        if ((count($marketplace_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $marketplace_ids when calling Rpr20210630CreateReportSpecification., number of items must be greater than or equal to 1.');
        }
