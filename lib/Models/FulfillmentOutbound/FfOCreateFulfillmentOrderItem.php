...
/**
 * FfOCreateFulfillmentOrderItem Class Doc Comment
 *
 * @category Class
 ...
 */
class FfOCreateFulfillmentOrderItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'per_unit_declared_value' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOMoney',
        'per_unit_price' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOMoney',
        'per_unit_tax' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOMoney'
    ];
    ...
    public function setSellerSku($seller_sku)
    {
        if ((mb_strlen($seller_sku) > 50)) {
            throw new \InvalidArgumentException('invalid length for $seller_sku when calling FfOCreateFulfillmentOrderItem., must be smaller than or equal to 50.');
        }
    ...
    public function setSellerFulfillmentOrderItemId($seller_fulfillment_order_item_id)
    {
        if ((mb_strlen($seller_fulfillment_order_item_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $seller_fulfillment_order_item_id when calling FfOCreateFulfillmentOrderItem., must be smaller than or equal to 50.');
        }
    ...
    public function setGiftMessage($gift_message)
    {
        if (!is_null($gift_message) && (mb_strlen($gift_message) > 512)) {
            throw new \InvalidArgumentException('invalid length for $gift_message when calling FfOCreateFulfillmentOrderItem., must be smaller than or equal to 512.');
        }
    ...
    public function setDisplayableComment($displayable_comment)
    {
        if (!is_null($displayable_comment) && (mb_strlen($displayable_comment) > 250)) {
            throw new \InvalidArgumentException('invalid length for $displayable_comment when calling FfOCreateFulfillmentOrderItem., must be smaller than or equal to 250.');
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOMoney|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOMoney|null $per_unit_declared_value per_unit_declared_value
     *
     * @return self
     */
     ...
     * Sets per_unit_price
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOMoney|null $per_unit_price per_unit_price
     *
     * @return self
     */
     ...
     * Sets per_unit_tax
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOMoney|null $per_unit_tax per_unit_tax
     *
     * @return self
     */
