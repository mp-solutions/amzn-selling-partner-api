...
/**
 * FfOTrackingAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class FfOTrackingAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCity($city)
    {
        if ((mb_strlen($city) > 150)) {
            throw new \InvalidArgumentException('invalid length for $city when calling FfOTrackingAddress., must be smaller than or equal to 150.');
        }
    ...
    public function setState($state)
    {
        if ((mb_strlen($state) > 150)) {
            throw new \InvalidArgumentException('invalid length for $state when calling FfOTrackingAddress., must be smaller than or equal to 150.');
        }
    ...
    public function setCountry($country)
    {
        if ((mb_strlen($country) > 6)) {
            throw new \InvalidArgumentException('invalid length for $country when calling FfOTrackingAddress., must be smaller than or equal to 6.');
        }
