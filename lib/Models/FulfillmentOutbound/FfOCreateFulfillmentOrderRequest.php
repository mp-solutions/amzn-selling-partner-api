...
/**
 * FfOCreateFulfillmentOrderRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class FfOCreateFulfillmentOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'shipping_speed_category' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOShippingSpeedCategory',
        'delivery_window' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfODeliveryWindow',
        'destination_address' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOAddress',
        'fulfillment_action' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOFulfillmentAction',
        'fulfillment_policy' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOFulfillmentPolicy',
        'cod_settings' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOCODSettings',
        'ship_from_country_code' => 'string',
        'notification_emails' => 'string[]',
        'feature_constraints' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOFeatureSettings[]',
        'items' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOCreateFulfillmentOrderItem[]'
    ];
    ...
    public function setSellerFulfillmentOrderId($seller_fulfillment_order_id)
    {
        if ((mb_strlen($seller_fulfillment_order_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $seller_fulfillment_order_id when calling FfOCreateFulfillmentOrderRequest., must be smaller than or equal to 40.');
        }
    ...
    public function setDisplayableOrderId($displayable_order_id)
    {
        if ((mb_strlen($displayable_order_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $displayable_order_id when calling FfOCreateFulfillmentOrderRequest., must be smaller than or equal to 40.');
        }
    ...
    public function setDisplayableOrderComment($displayable_order_comment)
    {
        if ((mb_strlen($displayable_order_comment) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $displayable_order_comment when calling FfOCreateFulfillmentOrderRequest., must be smaller than or equal to 1000.');
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOShippingSpeedCategory
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOShippingSpeedCategory $shipping_speed_category shipping_speed_category
     *
     * @return self
     */
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfODeliveryWindow|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfODeliveryWindow|null $delivery_window delivery_window
     *
     * @return self
     */
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOAddress
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOAddress $destination_address destination_address
     *
     * @return self
     */
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOFulfillmentAction|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOFulfillmentAction|null $fulfillment_action fulfillment_action
     *
     * @return self
     */
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOFulfillmentPolicy|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOFulfillmentPolicy|null $fulfillment_policy fulfillment_policy
     *
     * @return self
     */
     ...
     * Gets cod_settings
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOCODSettings|null
     */
     ...
     * Sets cod_settings
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOCODSettings|null $cod_settings cod_settings
     *
     * @return self
     */
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOFeatureSettings[]|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOFeatureSettings[]|null $feature_constraints A list of features and their fulfillment policies to apply to the order.
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOCreateFulfillmentOrderItem[]
     */
     ...
     * Sets items
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOCreateFulfillmentOrderItem[] $items An array of item information for creating a fulfillment order.
     *
     * @return self
     */
