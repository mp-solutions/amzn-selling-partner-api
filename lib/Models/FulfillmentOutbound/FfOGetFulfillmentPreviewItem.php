...
/**
 * FfOGetFulfillmentPreviewItem Class Doc Comment
 *
 * @category Class
 ...
 */
class FfOGetFulfillmentPreviewItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerSku($seller_sku)
    {
        if ((mb_strlen($seller_sku) > 50)) {
            throw new \InvalidArgumentException('invalid length for $seller_sku when calling FfOGetFulfillmentPreviewItem., must be smaller than or equal to 50.');
        }
    ...
    public function setSellerFulfillmentOrderItemId($seller_fulfillment_order_item_id)
    {
        if ((mb_strlen($seller_fulfillment_order_item_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $seller_fulfillment_order_item_id when calling FfOGetFulfillmentPreviewItem., must be smaller than or equal to 50.');
        }
