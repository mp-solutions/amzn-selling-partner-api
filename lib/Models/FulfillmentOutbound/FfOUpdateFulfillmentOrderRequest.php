...
/**
 * FfOUpdateFulfillmentOrderRequest Class Doc Comment
 *
 * @category Class
 * @package  MPSolutions\AmznSellingPartnerApi
 * @author   OpenAPI Generator team
 ...
 */
class FfOUpdateFulfillmentOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOUpdateFulfillmentOrderItem[]'
    ];
    ...
    public function setDisplayableOrderId($displayable_order_id)
    {
        if (!is_null($displayable_order_id) && (mb_strlen($displayable_order_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $displayable_order_id when calling FfOUpdateFulfillmentOrderRequest., must be smaller than or equal to 40.');
        }
    ...
    public function setDisplayableOrderComment($displayable_order_comment)
    {
        if (!is_null($displayable_order_comment) && (mb_strlen($displayable_order_comment) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $displayable_order_comment when calling FfOUpdateFulfillmentOrderRequest., must be smaller than or equal to 1000.');
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOShippingSpeedCategory|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOShippingSpeedCategory|null $shipping_speed_category shipping_speed_category
     *
     * @return self
     */
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOAddress|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOAddress|null $destination_address destination_address
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOUpdateFulfillmentOrderItem[]|null
     */
     ...
     * Sets items
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\FulfillmentOutbound\FfOUpdateFulfillmentOrderItem[]|null $items An array of fulfillment order item information for updating a fulfillment order.
     *
     * @return self
     */
