...
/**
 * FfOCreateReturnItem Class Doc Comment
 *
 * @category Class
 ...
 */
class FfOCreateReturnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerReturnItemId($seller_return_item_id)
    {
        if ((mb_strlen($seller_return_item_id) > 80)) {
            throw new \InvalidArgumentException('invalid length for $seller_return_item_id when calling FfOCreateReturnItem., must be smaller than or equal to 80.');
        }
    ...
    public function setReturnComment($return_comment)
    {
        if (!is_null($return_comment) && (mb_strlen($return_comment) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $return_comment when calling FfOCreateReturnItem., must be smaller than or equal to 1000.');
        }
