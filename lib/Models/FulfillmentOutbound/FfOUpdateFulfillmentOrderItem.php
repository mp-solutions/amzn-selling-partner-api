...
/**
 * FfOUpdateFulfillmentOrderItem Class Doc Comment
 *
 * @category Class
 ...
 */
class FfOUpdateFulfillmentOrderItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerFulfillmentOrderItemId($seller_fulfillment_order_item_id)
    {
        if ((mb_strlen($seller_fulfillment_order_item_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $seller_fulfillment_order_item_id when calling FfOUpdateFulfillmentOrderItem., must be smaller than or equal to 50.');
        }
    ...
    public function setGiftMessage($gift_message)
    {
        if (!is_null($gift_message) && (mb_strlen($gift_message) > 512)) {
            throw new \InvalidArgumentException('invalid length for $gift_message when calling FfOUpdateFulfillmentOrderItem., must be smaller than or equal to 512.');
        }
    ...
    public function setDisplayableComment($displayable_comment)
    {
        if (!is_null($displayable_comment) && (mb_strlen($displayable_comment) > 250)) {
            throw new \InvalidArgumentException('invalid length for $displayable_comment when calling FfOUpdateFulfillmentOrderItem., must be smaller than or equal to 250.');
        }
