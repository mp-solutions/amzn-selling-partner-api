 ...
 */
class VIcAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCountryCode($country_code)
    {
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling VIcAddress., must be smaller than or equal to 2.');
        }
