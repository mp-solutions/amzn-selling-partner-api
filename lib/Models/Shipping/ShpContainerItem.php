...
/**
 * ShpContainerItem Class Doc Comment
 *
 * @category Class
 ...
 */
class ShpContainerItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'quantity' => 'float',
        'unit_price' => '\MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpCurrency',
        'unit_weight' => '\MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpWeight',
        'title' => 'string'
    ];
     ...
     * Sets unit_price
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpCurrency $unit_price unit_price
     *
     * @return self
     */
     ...
     * Sets unit_weight
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpWeight $unit_weight unit_weight
     *
     * @return self
     */
    ...
    public function setTitle($title)
    {
        if ((mb_strlen($title) > 30)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ShpContainerItem., must be smaller than or equal to 30.');
        }
