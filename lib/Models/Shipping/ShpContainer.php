...
/**
 * ShpContainer Class Doc Comment
 *
 * @category Class
 ...
 */
class ShpContainer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'value' => '\MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpCurrency',
        'dimensions' => '\MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpDimensions',
        'items' => '\MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpContainerItem[]',
        'weight' => '\MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpWeight'
    ];
    ...
    public function setContainerReferenceId($container_reference_id)
    {
        if ((mb_strlen($container_reference_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $container_reference_id when calling ShpContainer., must be smaller than or equal to 40.');
        }
     ...
     * Sets value
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpCurrency $value value
     *
     * @return self
     */
     ...
     * Gets dimensions
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpDimensions
     */
     ...
     * Sets dimensions
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpDimensions $dimensions dimensions
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpContainerItem[]
     */
     ...
     * Sets items
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpContainerItem[] $items A list of the items in the container.
     *
     * @return self
     */
     ...
     * Sets weight
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpWeight $weight weight
     *
     * @return self
     */
