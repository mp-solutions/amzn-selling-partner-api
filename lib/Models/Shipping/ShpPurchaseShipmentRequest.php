...
/**
 * ShpPurchaseShipmentRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ShpPurchaseShipmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'label_specification' => '\MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpLabelSpecification'
    ];
    ...
    public function setClientReferenceId($client_reference_id)
    {
        if ((mb_strlen($client_reference_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $client_reference_id when calling ShpPurchaseShipmentRequest., must be smaller than or equal to 40.');
        }
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpLabelSpecification
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpLabelSpecification $label_specification label_specification
     *
     * @return self
     */
