 ...
 */
class ShpEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'event_code' => 'string',
        'event_time' => '\DateTime',
        'location' => '\MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpLocation'
    ];
    ...
    public function setEventCode($event_code)
    {
        if ((mb_strlen($event_code) > 60)) {
            throw new \InvalidArgumentException('invalid length for $event_code when calling ShpEvent., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($event_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $event_code when calling ShpEvent., must be bigger than or equal to 1.');
        }
     ...
     * Gets location
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpLocation|null
     */
     ...
     * Sets location
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpLocation|null $location location
     *
     * @return self
     */
