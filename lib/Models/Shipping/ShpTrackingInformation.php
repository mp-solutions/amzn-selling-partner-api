...
/**
 * ShpTrackingInformation Class Doc Comment
 *
 * @category Class
 ...
 */
class ShpTrackingInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'tracking_id' => 'string',
        'summary' => '\MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpTrackingSummary',
        'promised_delivery_date' => '\DateTime',
        'event_history' => '\MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpEvent[]'
    ];
    ...
    public function setTrackingId($tracking_id)
    {
        if ((mb_strlen($tracking_id) > 60)) {
            throw new \InvalidArgumentException('invalid length for $tracking_id when calling ShpTrackingInformation., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($tracking_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tracking_id when calling ShpTrackingInformation., must be bigger than or equal to 1.');
        }
     ...
     * Gets summary
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpTrackingSummary
     */
     ...
     * Sets summary
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpTrackingSummary $summary summary
     *
     * @return self
     */
     ...
     * Gets event_history
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpEvent[]
     */
     ...
     * Sets event_history
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpEvent[] $event_history A list of events of a shipment.
     *
     * @return self
     */
