...
class CreateShipmentResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'shipment_id' => 'string',
        'eligible_rates' => '\MPSolutions\AmznSellingPartnerApi\Models\Shipping\Rate[]'
    ];
     ...
     * Gets eligible_rates
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Shipping\Rate[]
     */
     ...
     * Sets eligible_rates
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Shipping\Rate[] $eligible_rates A list of all the available rates that can be used to send the shipment.
     *
     * @return self
     */
