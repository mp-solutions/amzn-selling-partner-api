 ...
 */
class ShpAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setAccountId($account_id)
    {
        if ((mb_strlen($account_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling ShpAccount., must be smaller than or equal to 10.');
        }
