...
/**
 * ShpPurchaseLabelsResult Class Doc Comment
 *
 * @category Class
 ...
 */
class ShpPurchaseLabelsResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'label_results' => '\MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpLabelResult[]'
    ];
    ...
    public function setClientReferenceId($client_reference_id)
    {
        if (!is_null($client_reference_id) && (mb_strlen($client_reference_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $client_reference_id when calling ShpPurchaseLabelsResult., must be smaller than or equal to 40.');
        }
     ...
     * Gets accepted_rate
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpAcceptedRate
     */
     ...
     * Sets accepted_rate
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpAcceptedRate $accepted_rate accepted_rate
     *
     * @return self
     */
     ...
     * Gets label_results
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpLabelResult[]
     */
     ...
     * Sets label_results
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpLabelResult[] $label_results A list of label results
     *
     * @return self
     */
