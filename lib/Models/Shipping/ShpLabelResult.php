...
/**
 * ShpLabelResult Class Doc Comment
 *
 * @category Class
 ...
 */
class ShpLabelResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'tracking_id' => 'string',
        'label' => '\MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpLabel'
    ];
    ...
    public function setContainerReferenceId($container_reference_id)
    {
        if (!is_null($container_reference_id) && (mb_strlen($container_reference_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $container_reference_id when calling ShpLabelResult., must be smaller than or equal to 40.');
        }
     ...
     * Gets label
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpLabel|null
     */
     ...
     * Sets label
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpLabel|null $label label
     *
     * @return self
     */
