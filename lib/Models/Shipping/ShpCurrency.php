 ...
 */
class ShpCurrency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        if ((mb_strlen($unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling ShpCurrency., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($unit) < 3)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling ShpCurrency., must be bigger than or equal to 3.');
        }
