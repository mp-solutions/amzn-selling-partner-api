...
/**
 * ShpCreateShipmentRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ShpCreateShipmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setClientReferenceId($client_reference_id)
    {
        if ((mb_strlen($client_reference_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $client_reference_id when calling ShpCreateShipmentRequest., must be smaller than or equal to 40.');
        }
