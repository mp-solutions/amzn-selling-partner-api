...
class LabelResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'tracking_id' => 'string',
        'label' => '\MPSolutions\AmznSellingPartnerApi\Models\Shipping\Label'
    ];
     ...
     * Gets label
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Shipping\Label|null
     */
     ...
     * Sets label
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Shipping\Label|null $label label
     *
     * @return self
     */
