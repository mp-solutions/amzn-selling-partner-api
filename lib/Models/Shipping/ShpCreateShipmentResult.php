...
/**
 * ShpCreateShipmentResult Class Doc Comment
 *
 * @category Class
 ...
 */
class ShpCreateShipmentResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'shipment_id' => 'string',
        'eligible_rates' => '\MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpRate[]'
    ];
     ...
     * Gets eligible_rates
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpRate[]
     */
     ...
     * Sets eligible_rates
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Shipping\ShpRate[] $eligible_rates A list of all the available rates that can be used to send the shipment.
     *
     * @return self
     */
