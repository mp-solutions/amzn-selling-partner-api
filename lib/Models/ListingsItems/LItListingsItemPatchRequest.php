...
/**
 * LItListingsItemPatchRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class LItListingsItemPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'product_type' => 'string',
        'patches' => '\MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\LItPatchOperation[]'
    ];
     ...
     * Gets patches
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\LItPatchOperation[]
     */
     ...
     * Sets patches
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\ListingsItems\LItPatchOperation[] $patches One or more JSON Patch operations to perform on the listings item.
     *
     * @return self
     */
    public function setPatches($patches)
    {
        ...
        if ((count($patches) < 1)) {
            throw new \InvalidArgumentException('invalid length for $patches when calling LItListingsItemPatchRequest., number of items must be greater than or equal to 1.');
        }
