...
/**
 * MsgCreateConfirmCustomizationDetailsRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class MsgCreateConfirmCustomizationDetailsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'text' => 'string',
        'attachments' => '\MPSolutions\AmznSellingPartnerApi\Models\Messaging\MsgAttachment[]'
    ];
    ...
    public function setText($text)
    {
        if (!is_null($text) && (mb_strlen($text) > 800)) {
            throw new \InvalidArgumentException('invalid length for $text when calling MsgCreateConfirmCustomizationDetailsRequest., must be smaller than or equal to 800.');
        }
        if (!is_null($text) && (mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling MsgCreateConfirmCustomizationDetailsRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets attachments
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Messaging\MsgAttachment[]|null
     */
     ...
     * Sets attachments
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Messaging\MsgAttachment[]|null $attachments Attachments to include in the message to the buyer.
     *
     * @return self
     */
