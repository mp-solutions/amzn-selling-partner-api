...
class CreateWarrantyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'attachments' => '\MPSolutions\AmznSellingPartnerApi\Models\Messaging\Attachment[]',
     ...
     * Gets attachments
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Messaging\Attachment[]|null
     */
     ...
     * Sets attachments
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Messaging\Attachment[]|null $attachments Attachments to include in the message to the buyer. If any text is included in the attachment, the text must be written in the buyer's language of preference, which can be retrieved from the GetAttributes operation.
     *
     * @return self
     */
