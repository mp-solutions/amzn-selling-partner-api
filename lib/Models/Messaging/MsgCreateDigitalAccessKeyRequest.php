...
/**
 * MsgCreateDigitalAccessKeyRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class MsgCreateDigitalAccessKeyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setText($text)
    {
        if (!is_null($text) && (mb_strlen($text) > 400)) {
            throw new \InvalidArgumentException('invalid length for $text when calling MsgCreateDigitalAccessKeyRequest., must be smaller than or equal to 400.');
        }
        if (!is_null($text) && (mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling MsgCreateDigitalAccessKeyRequest., must be bigger than or equal to 1.');
        }
