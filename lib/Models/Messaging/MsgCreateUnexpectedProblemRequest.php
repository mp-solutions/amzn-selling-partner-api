...
/**
 * MsgCreateUnexpectedProblemRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class MsgCreateUnexpectedProblemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setText($text)
    {
        if (!is_null($text) && (mb_strlen($text) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $text when calling MsgCreateUnexpectedProblemRequest., must be smaller than or equal to 2000.');
        }
        if (!is_null($text) && (mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling MsgCreateUnexpectedProblemRequest., must be bigger than or equal to 1.');
        }
