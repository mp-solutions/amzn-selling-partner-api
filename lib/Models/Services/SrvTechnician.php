...
/**
 * SrvTechnician Class Doc Comment
 *
 * @category Class
 ...
 */
class SrvTechnician implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setTechnicianId($technician_id)
    {
        if (!is_null($technician_id) && (mb_strlen($technician_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $technician_id when calling SrvTechnician., must be smaller than or equal to 50.');
        }
        if (!is_null($technician_id) && (mb_strlen($technician_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $technician_id when calling SrvTechnician., must be bigger than or equal to 1.');
        }
