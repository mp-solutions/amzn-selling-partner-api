...
/**
 * SrvServiceJobProvider Class Doc Comment
 *
 * @category Class
 ...
 */
class SrvServiceJobProvider implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setServiceJobProviderId($service_job_provider_id)
    {
        ...
        if (!is_null($service_job_provider_id) && (!preg_match("/^[A-Z0-9]*$/", $service_job_provider_id))) {
            throw new \InvalidArgumentException("invalid value for $service_job_provider_id when calling SrvServiceJobProvider., must conform to the pattern /^[A-Z0-9]*$/.");
        }
