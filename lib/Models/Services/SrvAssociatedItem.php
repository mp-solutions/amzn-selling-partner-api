...
/**
 * SrvAssociatedItem Class Doc Comment
 *
 * @category Class
 ...
 */
class SrvAssociatedItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'item_status' => 'string',
        'brand_name' => 'string',
        'item_delivery' => '\MPSolutions\AmznSellingPartnerApi\Models\Services\SrvItemDelivery'
    ];
    ...
    public function setOrderId($order_id)
    {
        if (!is_null($order_id) && (mb_strlen($order_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling SrvAssociatedItem., must be smaller than or equal to 20.');
        }
        if (!is_null($order_id) && (mb_strlen($order_id) < 5)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling SrvAssociatedItem., must be bigger than or equal to 5.');
        }
     ...
     * Gets item_delivery
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvItemDelivery|null
     */
     ...
     * Sets item_delivery
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvItemDelivery|null $item_delivery item_delivery
     *
     * @return self
     */
