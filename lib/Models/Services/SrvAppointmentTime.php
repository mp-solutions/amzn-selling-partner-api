...
/**
 * SrvAppointmentTime Class Doc Comment
 *
 * @category Class
 ...
 */
class SrvAppointmentTime implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setDurationInMinutes($duration_in_minutes)
    {
        ...
        if (($duration_in_minutes < 1)) {
            throw new \InvalidArgumentException('invalid value for $duration_in_minutes when calling SrvAppointmentTime., must be bigger than or equal to 1.');
        }
