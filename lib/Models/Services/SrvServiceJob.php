...
namespace MPSolutions\AmznSellingPartnerApi\Models\Services;
...
/**
 * SrvServiceJob Class Doc Comment
 *
 * @category Class
 ...
 */
class SrvServiceJob implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'scope_of_work' => '\MPSolutions\AmznSellingPartnerApi\Models\Services\SrvScopeOfWork',
        'seller' => '\MPSolutions\AmznSellingPartnerApi\Models\Services\SrvSeller',
        'service_job_provider' => '\MPSolutions\AmznSellingPartnerApi\Models\Services\SrvServiceJobProvider',
        'preferred_appointment_times' => '\MPSolutions\AmznSellingPartnerApi\Models\Services\SrvAppointmentTime[]',
        'appointments' => '\MPSolutions\AmznSellingPartnerApi\Models\Services\SrvAppointment[]',
        'service_order_id' => 'string',
        'marketplace_id' => 'string',
        'buyer' => '\MPSolutions\AmznSellingPartnerApi\Models\Services\SrvBuyer',
        'associated_items' => '\MPSolutions\AmznSellingPartnerApi\Models\Services\SrvAssociatedItem[]',
        'service_location' => '\MPSolutions\AmznSellingPartnerApi\Models\Services\SrvServiceLocation'
    ];
    ...
    public function setServiceJobId($service_job_id)
    {
        if (!is_null($service_job_id) && (mb_strlen($service_job_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $service_job_id when calling SrvServiceJob., must be smaller than or equal to 100.');
        }
        if (!is_null($service_job_id) && (mb_strlen($service_job_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $service_job_id when calling SrvServiceJob., must be bigger than or equal to 1.');
        }
     ...
     * Gets scope_of_work
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvScopeOfWork|null
     */
     ...
     * Sets scope_of_work
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvScopeOfWork|null $scope_of_work scope_of_work
     *
     * @return self
     */
     ...
     * Gets seller
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvSeller|null
     */
     ...
     * Sets seller
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvSeller|null $seller seller
     *
     * @return self
     */
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvServiceJobProvider|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvServiceJobProvider|null $service_job_provider service_job_provider
     *
     * @return self
     */
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvAppointmentTime[]|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvAppointmentTime[]|null $preferred_appointment_times A list of appointment windows preferred by the buyer. Included only if the buyer selected appointment windows when creating the order.
     *
     * @return self
     */
     ...
     * Gets appointments
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvAppointment[]|null
     */
     ...
     * Sets appointments
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvAppointment[]|null $appointments A list of appointments.
     *
     * @return self
     */
    ...
    public function setServiceOrderId($service_order_id)
    {
        if (!is_null($service_order_id) && (mb_strlen($service_order_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $service_order_id when calling SrvServiceJob., must be smaller than or equal to 20.');
        }
        if (!is_null($service_order_id) && (mb_strlen($service_order_id) < 5)) {
            throw new \InvalidArgumentException('invalid length for $service_order_id when calling SrvServiceJob., must be bigger than or equal to 5.');
        }
    ...
    public function setMarketplaceId($marketplace_id)
    {
        ...
        if (!is_null($marketplace_id) && (!preg_match("/^[A-Z0-9]*$/", $marketplace_id))) {
            throw new \InvalidArgumentException("invalid value for $marketplace_id when calling SrvServiceJob., must conform to the pattern /^[A-Z0-9]*$/.");
        }
     ...
     * Gets buyer
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvBuyer|null
     */
     ...
     * Sets buyer
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvBuyer|null $buyer buyer
     *
     * @return self
     */
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvAssociatedItem[]|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvAssociatedItem[]|null $associated_items A list of items associated with the service job.
     *
     * @return self
     */
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvServiceLocation|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvServiceLocation|null $service_location service_location
     *
     * @return self
     */
