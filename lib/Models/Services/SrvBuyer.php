 ...
 */
class SrvBuyer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setBuyerId($buyer_id)
    {
        ...
        if (!is_null($buyer_id) && (!preg_match("/^[A-Z0-9]*$/", $buyer_id))) {
            throw new \InvalidArgumentException("invalid value for $buyer_id when calling SrvBuyer., must conform to the pattern /^[A-Z0-9]*$/.");
        }
