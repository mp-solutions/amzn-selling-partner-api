 ...
 */
class SrvPoa implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'technicians' => '\MPSolutions\AmznSellingPartnerApi\Models\Services\SrvTechnician[]',
     ...
     * Sets technicians
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvTechnician[]|null $technicians A list of technicians.
     *
     * @return self
     */
    public function setTechnicians($technicians)
    {
        ...
        if (!is_null($technicians) && (count($technicians) < 1)) {
            throw new \InvalidArgumentException('invalid length for $technicians when calling SrvPoa., number of items must be greater than or equal to 1.');
        }
    ...
    public function setUploadingTechnician($uploading_technician)
    {
        ...
        if (!is_null($uploading_technician) && (!preg_match("/^[A-Z0-9]*$/", $uploading_technician))) {
            throw new \InvalidArgumentException("invalid value for $uploading_technician when calling SrvPoa., must conform to the pattern /^[A-Z0-9]*$/.");
        }
