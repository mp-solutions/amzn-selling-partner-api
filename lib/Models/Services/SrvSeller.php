 ...
 */
class SrvSeller implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerId($seller_id)
    {
        ...
        if (!is_null($seller_id) && (!preg_match("/^[A-Z0-9]*$/", $seller_id))) {
            throw new \InvalidArgumentException("invalid value for $seller_id when calling SrvSeller., must conform to the pattern /^[A-Z0-9]*$/.");
        }
