...
/**
 * SrvAppointment Class Doc Comment
 *
 * @category Class
 ...
 */
class SrvAppointment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'appointment_time' => '\MPSolutions\AmznSellingPartnerApi\Models\Services\SrvAppointmentTime',
        'assigned_technicians' => '\MPSolutions\AmznSellingPartnerApi\Models\Services\SrvTechnician[]',
        'rescheduled_appointment_id' => 'string',
        'poa' => '\MPSolutions\AmznSellingPartnerApi\Models\Services\SrvPoa'
    ];
    ...
    public function setAppointmentId($appointment_id)
    {
        if (!is_null($appointment_id) && (mb_strlen($appointment_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $appointment_id when calling SrvAppointment., must be smaller than or equal to 100.');
        }
        if (!is_null($appointment_id) && (mb_strlen($appointment_id) < 5)) {
            throw new \InvalidArgumentException('invalid length for $appointment_id when calling SrvAppointment., must be bigger than or equal to 5.');
        }
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvAppointmentTime|null $appointment_time appointment_time
     *
     * @return self
     */
     ...
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvTechnician[]|null
     */
     ...
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvTechnician[]|null $assigned_technicians A list of technicians assigned to the service job.
     *
     * @return self
     */
    public function setAssignedTechnicians($assigned_technicians)
    {
        ...
        if (!is_null($assigned_technicians) && (count($assigned_technicians) < 1)) {
            throw new \InvalidArgumentException('invalid length for $assigned_technicians when calling SrvAppointment., number of items must be greater than or equal to 1.');
        }
    ...
    public function setRescheduledAppointmentId($rescheduled_appointment_id)
    {
        if (!is_null($rescheduled_appointment_id) && (mb_strlen($rescheduled_appointment_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $rescheduled_appointment_id when calling SrvAppointment., must be smaller than or equal to 100.');
        }
        if (!is_null($rescheduled_appointment_id) && (mb_strlen($rescheduled_appointment_id) < 5)) {
            throw new \InvalidArgumentException('invalid length for $rescheduled_appointment_id when calling SrvAppointment., must be bigger than or equal to 5.');
        }
     ...
     * Gets poa
     *
     * @return \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvPoa|null
     */
     ...
     * Sets poa
     *
     * @param \MPSolutions\AmznSellingPartnerApi\Models\Services\SrvPoa|null $poa poa
     *
     * @return self
     */
