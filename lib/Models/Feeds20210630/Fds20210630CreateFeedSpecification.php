...
namespace MPSolutions\AmznSellingPartnerApi\Models\Feeds20210630;
...
/**
 * Fds20210630CreateFeedSpecification Class Doc Comment
 *
 * @category Class
 ...
 */
class Fds20210630CreateFeedSpecification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setMarketplaceIds($marketplace_ids)
    {
        ...
        if ((count($marketplace_ids) > 25)) {
            throw new \InvalidArgumentException('invalid value for $marketplace_ids when calling Fds20210630CreateFeedSpecification., number of items must be less than or equal to 25.');
        }
        if ((count($marketplace_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $marketplace_ids when calling Fds20210630CreateFeedSpecification., number of items must be greater than or equal to 1.');
        }
