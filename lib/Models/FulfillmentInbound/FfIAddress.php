 ...
 */
class FfIAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FfIAddress., must be smaller than or equal to 50.');
        }
    ...
    public function setAddressLine1($address_line1)
    {
        if ((mb_strlen($address_line1) > 180)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling FfIAddress., must be smaller than or equal to 180.');
        }
    ...
    public function setAddressLine2($address_line2)
    {
        if (!is_null($address_line2) && (mb_strlen($address_line2) > 60)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling FfIAddress., must be smaller than or equal to 60.');
        }
    ...
    public function setDistrictOrCounty($district_or_county)
    {
        if (!is_null($district_or_county) && (mb_strlen($district_or_county) > 25)) {
            throw new \InvalidArgumentException('invalid length for $district_or_county when calling FfIAddress., must be smaller than or equal to 25.');
        }
    ...
    public function setCity($city)
    {
        if ((mb_strlen($city) > 30)) {
            throw new \InvalidArgumentException('invalid length for $city when calling FfIAddress., must be smaller than or equal to 30.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        if ((mb_strlen($postal_code) > 30)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling FfIAddress., must be smaller than or equal to 30.');
        }
