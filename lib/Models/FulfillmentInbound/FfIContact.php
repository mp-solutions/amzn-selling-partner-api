 ...
 */
class FfIContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FfIContact., must be smaller than or equal to 50.');
        }
    ...
    public function setPhone($phone)
    {
        if ((mb_strlen($phone) > 20)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling FfIContact., must be smaller than or equal to 20.');
        }
    ...
    public function setEmail($email)
    {
        if ((mb_strlen($email) > 50)) {
            throw new \InvalidArgumentException('invalid length for $email when calling FfIContact., must be smaller than or equal to 50.');
        }
    ...
    public function setFax($fax)
    {
        if (!is_null($fax) && (mb_strlen($fax) > 20)) {
            throw new \InvalidArgumentException('invalid length for $fax when calling FfIContact., must be smaller than or equal to 20.');
        }
