...
class Configuration
{
	use \MPSolutions\AmznSellingPartnerApi\ConfigurationTrait;
    /**
     * @var Configuration
     */
    ...
    {
        $report  = 'PHP SDK (MPSolutions\AmznSellingPartnerApi) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2020-12-01' . PHP_EOL;
